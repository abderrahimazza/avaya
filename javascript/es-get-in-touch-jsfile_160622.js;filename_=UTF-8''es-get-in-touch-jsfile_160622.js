...
labelatt('fe85497');//hide EmailOptin label
...
document.getElementById("fe85497").type = "hidden"; //EmailOptin is text field to hide this field
...
divGDPRtext.innerHTML = "<div style='color: #313133;width: 95%;margin-left: 5px;margin-bottom: 30px;margin-top: 15px;font-size:12px;line-height:20px;' class='formStatement'>Al enviar este formulario, acepto que mi información se procese en la base de datos de Avaya para el propósito mencionado anteriormente. Consulte nuestra <a href='https://www.avaya.com/es/privacy/website/' target='_blank' class='formStatLink' target='_blank' style='text-decoration:underline;font-size: 12px;border-bottom: 0px solid;color:#1B77AF;'>Declaración de privacidad</a> para obtener más detalles o administre sus <a href='https://news.avaya.com/global-subscription' target='_blank' class='formStatLink' target='_blank' style='text-decoration:underline;font-size: 12px;border-bottom: 0px solid;color: #1B77AF;'>preferencias de correo electrónico</a> en cualquier momento.</div>";
...
//var SessTAC = getCookie('tac');
		if (getUrlVar("CTA") != ""){
			...
			document.getElementsByName("cta_code")[0].value = "WEB-GET-ES";
		}
		if (getUrlVar("TAC") != ""){
			document.getElementsByName("tactic_code")[0].value = getUrlVar("TAC");
		}/*else if (SessTAC != null) {
			console.log(SessTAC);
         	document.getElementsByName("tactic_code")[0].value = SessTAC;
		}*/ else {
			document.getElementsByName("tactic_code")[0].value = "WEB-GET-ES";
		}
...
subonclick= document.getElementById("fe85503");
...
/*document.getElementsByName('postal_code')[0].onchange = function(){
	var CTAVal = document.getElementsByName("cta_code")[0].value;
		var CTAVal2 = CTAVal.toUpperCase();
		var TACVal = document.getElementsByName("tactic_code")[0].value;
		var TACVal2 = TACVal.toUpperCase();
	if (CTAVal2.indexOf("-BRD") !== -1){
			document.getElementsByName('lastAreaOfInterest')[0].value = "Brand";
		} else if (CTAVal2.indexOf("-CLD") !== -1){
			document.getElementsByName('lastAreaOfInterest')[0].value = "Cloud";
		} else if (CTAVal2.indexOf("-DV") !== -1){
			document.getElementsByName('lastAreaOfInterest')[0].value = "Devices";
		} else if (CTAVal2.indexOf("-CC") !== -1){
			document.getElementsByName('lastAreaOfInterest')[0].value = "CC";
		} else if (CTAVal2.indexOf("-UC") !== -1){
			document.getElementsByName('lastAreaOfInterest')[0].value = "UC";
		} else if (CTAVal2.indexOf("-SV") !== -1){
			document.getElementsByName('lastAreaOfInterest')[0].value = "Services";
		} else if (TACVal2.indexOf("-BRD") !== -1){
			document.getElementsByName('lastAreaOfInterest')[0].value = "Brand";
		} else if (TACVal2.indexOf("-CLD") !== -1){
			document.getElementsByName('lastAreaOfInterest')[0].value = "Cloud";
...
//for Validation
fe85472.add(Validate.Presence, {failureMessage:"Campo requerido"});
fe85473.add(Validate.Presence, {failureMessage:"Campo requerido"});
fe85474.add(Validate.Presence, {failureMessage:"Campo requerido"});
fe85474.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "Por favor inserte una dirección valida de e-mail"});
fe85475.add(Validate.Presence, {failureMessage:"Campo requerido"});
fe85476.add(Validate.Presence, {failureMessage:"Campo requerido"});
fe85477.add(Validate.Presence, {failureMessage:"Campo requerido"});
fe85478.add(Validate.Presence, {failureMessage:"Campo requerido"});
//fe85479.add(Validate.Presence, {failureMessage:"Campo requerido"});
...
/*GA*/
 ...
 document.getElementById('form3016').addEventListener(
...
/*** GDPR Optin / Optout Code **************/
			...
			function checkOptin(){
				...
				if(checkbox1.checked == true){
					...
					document.getElementsByName("emailOptinSource1")[0].value = "WEB-GET-FR";
