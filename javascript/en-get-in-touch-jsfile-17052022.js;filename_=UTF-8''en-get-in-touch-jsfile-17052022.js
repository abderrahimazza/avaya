...
/*** GDPR Optin / Optout Code **************/
			...
			function checkOptin(){
				...
				if(checkbox1.checked == true){
					...
					document.getElementsByName("emailOptinSource1")[0].value = "WEB-GET-EN";
...
labelatt('fe84734');//hide EmailOptin label
...
document.getElementById("fe84734").type = "hidden"; //EmailOptin is text field to hide this field
...
document.getElementsByName("postal_code")[0].setAttribute("aria-label", "Postal Code");
...
subonclick= document.getElementById("fe84741");
...
//for Validation
fe84709.add(Validate.Presence, {failureMessage:"This field is required"});
fe84710.add(Validate.Presence, {failureMessage:"This field is required"});
fe84711.add(Validate.Presence, {failureMessage:"This field is required"});
fe84711.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "A valid email address is required"});
fe84712.add(Validate.Presence, {failureMessage:"This field is required"});
fe84713.add(Validate.Presence, {failureMessage:"This field is required"});
fe84714.add(Validate.Presence, {failureMessage:"This field is required"});
fe84715.add(Validate.Presence, {failureMessage:"This field is required"});
fe84716.add(Validate.Presence, {failureMessage:"This field is required"});
...
/*GA*/
 ...
 document.getElementById('form2990').addEventListener(
...
/*
var _elqQ = _elqQ || [];
    _elqQ.push(['elqSetSiteId', '1737033466']);
...
if (typeof this.GetElqCustomerGUID === 'function') {
        document.forms["Get-in-touch-raw-data-design"].elements["elqCustomerGUID"].value = GetElqCustomerGUID();
return;
}
timeout -= 1;
}
