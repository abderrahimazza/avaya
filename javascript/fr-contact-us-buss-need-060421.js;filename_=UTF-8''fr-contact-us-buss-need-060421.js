...
/*** GDPR Optin / Optout Code **************/
			...
			function checkOptin(){
				...
				if(checkbox1.checked == true){
					...
					document.getElementsByName("emailOptinSource1")[0].value = "FR-OWCS-contact-us";
...
labelatt('fe86776');//hide EmailOptin label
...
document.getElementById("fe86776").type = "hidden"; //EmailOptin is text field to hide this field
...
divGDPRtext.innerHTML = "<div style='color: #000;width: 90%;margin-left: 25px;margin-bottom: 30px;margin-top: 15px;font-size:13px;line-height:20px;'>En soumettant ce formulaire, j'accepte que mes informations soient traitées dans la base de données Avaya, dans le but mentionné ci-dessus. Consultez notre <a href='https://www.avaya.com/fr/privacy/commitment/' target='_blank' style='color:#DA291C;text-decoration:underline;font-size: 13px;border-bottom: 0px solid;'>déclaration de confidentialité</a> pour plus de détails ou gérez vos <a href='https://news.avaya.com/global-subscription' target='_blank' style='color:#DA291C;text-decoration:underline;font-size: 13px;border-bottom: 0px solid;'>préférences de courrier électronique</a> quand vous le souhaitez.</div>";
...
document.getElementsByName("contentTitle1")[0].value = "Discuter avec un Expert";//Insert content title here
...
//for Validation
fe86751.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe86752.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe86753.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe86753.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "Une adresse e-mail valide est requise"});
fe86754.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe86755.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe86758.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
...
if (SessCTA != null) {
    ...
    if (pageURL.includes("/solutions/customer-experience-and-contact-center/")){
        document.getElementsByName("cta_code")[0].value = "WEB-GET-FR-CE";
        document.getElementsByName("tactic_code")[0].value = "WEB-GET-FR-CE";
        document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-FR-CE";
        document.getElementsByName("contentTitle1")[0].value = "Pour mener à bien la transformation de votre Expérience Client";//Insert content title here
        ...
        document.getElementsByName("cta_code")[0].value = "WEB-GET-FR-TEAM";
        document.getElementsByName("tactic_code")[0].value = "WEB-GET-FR-TEAM";
        document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-FR-TEAM";
        document.getElementsByName("contentTitle1")[0].value = "Pour développer l'intelligence collective et développer le travail collaboratif";//Insert content title here
        document.getElementsByName('area_of_interest')[0].value = "UC";
    } else if (pageURL.includes("/solutions/digital-transformation/")){
        document.getElementsByName("cta_code")[0].value = "WEB-GET-FR-DX";
        document.getElementsByName("tactic_code")[0].value = "WEB-GET-FR-DX";
        document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-FR-DX";
        document.getElementsByName("contentTitle1")[0].value = "Commencez l'expérience";//Insert content title here
        document.getElementsByName('area_of_interest')[0].value = "UC";
    }
}
...
subonclick= document.getElementById("fe86782");
