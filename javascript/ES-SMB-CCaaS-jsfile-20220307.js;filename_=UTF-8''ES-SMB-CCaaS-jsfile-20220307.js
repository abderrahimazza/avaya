...
/*** GDPR Optin / Optout Code **************/
			...
			function checkOptin(){
				...
				if(checkbox1.checked == true){
					...
					document.getElementsByName("emailOptinSource1")[0].value = "WEB-GET-ES-SMB-CC";
...
vUsingCCSolutionYes.onclick = function(){
	...
	//if (document.getElementsByName('UsingCCSolution')[0].value == "Yes"){
		...
		var fe109362 = new LiveValidation( "fe109362", { validMessage: "", onlyOnBlur: true });
		fe109362.enable();
		fe109362.add( Validate.Presence, { failureMessage: "Campo requerido" } );	
	//} else {		
...
document.getElementById("fe109381").type = "hidden"; //EmailOptin is text field to hide this field
...
if (document.getElementById('formElement7')){
	...
	if (document.getElementById('fe109360')){
		var div71a = document.getElementById('fe109360');
...
if (document.getElementById('formElement8')){
	...
	if (document.getElementById('fe109361')){
		var div81a = document.getElementById('fe109361');
		...
		div81b[1].setAttribute("style", "width: 60px !important;display: table-cell;vertical-align: top;");
...
divGDPRtext.innerHTML = "<div style='color: #000;width: 90%;margin-left: 25px;margin-bottom: 30px;margin-top: 15px;font-size:13px;line-height:20px;'>Al enviar este formulario, acepto que mi información se procese en la base de datos de Avaya para el propósito mencionado anteriormente. Consulta nuestra <a href='https://www.avaya.com/es/privacy/website/' target='_blank' style='color:#CC0000;font-size:13px;line-height:20px;'>Declaración de privacidad</a> para obtener más detalles o administra tus <a href='https://news.avaya.com/global-subscription' target='_blank' style='color:#CC0000;font-size:13px;line-height:20px;'>preferencias de correo electrónico</a> en cualquier momento.</div>";
...
document.getElementsByName("content_title")[0].value = "Contacta con el departamento comercial";//passing value for content title
...
fe109353.add(Validate.Presence, {failureMessage:"Campo requerido"});
fe109354.add(Validate.Presence, {failureMessage:"Campo requerido"});
fe109355.add(Validate.Presence, {failureMessage:"Campo requerido"});
fe109355.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "Une adresse e-mail valide est requise"});
fe109356.add(Validate.Presence, {failureMessage:"Campo requerido"});
fe109357.add(Validate.Presence, {failureMessage:"Campo requerido"});
fe109358.add(Validate.Presence, {failureMessage:"Campo requerido"});
fe109359.add(Validate.Presence, {failureMessage:"Campo requerido"});
...
var div14a = document.getElementById('fe109389');
...
function OnLoadCreateFields(){
	...
	AreYouCurrentAvayaCustomerValid.add( Validate.Presence, { failureMessage: "Campo requerido" } );
	...
	UsingCCSolutionValid.add( Validate.Presence, { failureMessage: "Campo requerido" } );
...
if (getUrlVar("CTA") != ""){
	...
	if (pageURL.includes("/productos/ccaas/public/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-EN-SMB-CC";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-EN-SMB-CC-ES";
	}else if (pageURL.includes("/products/ccaas/public-pricing/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-EN-SMB-CC";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-EN-SMB-CC-PRC-ES";
	} else if (pageURL.includes("/products/ccaas/public-features/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-EN-SMB-CC";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-EN-SMB-CC-FEA-ES";
	} 
}
if (getUrlVar("TAC") != ""){
