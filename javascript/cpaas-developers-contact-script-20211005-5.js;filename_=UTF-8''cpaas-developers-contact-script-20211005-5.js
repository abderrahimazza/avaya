...
//document.getElementById("formElement6").style.display = "none";//not to display comment field container
//document.getElementById("formElement7").style.display = "none";//not to display optin field container
//document.getElementById("formElement8").style.display = "none";//not to display title field container
//document.getElementById("formElement9").style.display = "none";//not to display employee total range field container
document.getElementById("formElement10").style.display = "none";//not to display state field container
document.getElementById("formElement11").style.display = "none";//not to display address 3 field container
...
/*** GDPR Optin / Optout Code **************/
			...
			function checkOptin(){
				...
				if(checkbox1.checked == true){
					...
					document.getElementsByName("emailOptinSource1")[0].value = "22CPSGL-CONTACT-CO";
...
labelatt('fe129873');//hide EmailOptin label
...
document.getElementById("fe129873").type = "hidden";//EmailOptin is text field to hide this field
...
divGDPRtext.innerHTML = "<div style='color: #000;width: 90%;margin-left: 25px;margin-bottom: 30px;margin-top: 15px;font-size:13px;line-height:20px;font-weight: lighter;'>By submitting this form, I agree to my information being processed in the Avaya database for the above mentioned purpose. See our <a href='https://www.avaya.com/en/privacy/website/' target='_blank' style='text-decoration:underline;'>Privacy Statement</a> for more details, or manage your <a href='https://news.avaya.com/global-subscription' target='_blank' style='text-decoration:underline;'>Email Preferences</a> at any time.</div>";
...
document.getElementById("lb1").style.fontWeight = "lighter";
...
//console.log(strUser);
document.getElementsByName("EmoptIn")[0].style.marginTop = "25px";
document.getElementById("lb1").style.marginTop = "21px";
...
document.getElementsByName("contentTitle1")[0].value = "Welcome Developers - With Avaya OneCloud CPaaS you can create communication applications and workflows that fit the needs of your business.";//Insert content title here
...
document.getElementsByName("landing_page")[0].value = "https://www.avaya.com/en/confirm/contact-avaya-sales-confirmation/";
...
if (getUrlVar("CTA") != ""){
	...
	document.getElementsByName("cta_code")[0].value = "22CPSGL-CONTACT";
}
if (getUrlVar("TAC") != ""){
	document.getElementsByName("tactic_code")[0].value = getUrlVar("TAC");
} else {
	document.getElementsByName("tactic_code")[0].value = "22CPSGL-CONTACT-CO";
}


//for Validation
fe129855.add(Validate.Presence, {failureMessage:"This field is required"});
fe129856.add(Validate.Presence, {failureMessage:"This field is required"});
fe129857.add(Validate.Presence, {failureMessage:"This field is required"});
fe129857.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "A valid email address is required"});
fe129858.add(Validate.Presence, {failureMessage:"This field is required"});
fe129859.add(Validate.Presence, {failureMessage:"This field is required"});
fe129860.add(Validate.Presence, {failureMessage:"This field is required"});
fe129952.add(Validate.Presence, {failureMessage:"This field is required"});
fe129951.add(Validate.Presence, {failureMessage:"This field is required"});

subonclick= document.getElementById("fe129906");
...
/*GA*/
 ...
 document.getElementById('form3967').addEventListener(
