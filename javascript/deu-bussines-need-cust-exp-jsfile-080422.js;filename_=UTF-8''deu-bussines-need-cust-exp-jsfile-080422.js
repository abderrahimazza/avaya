...
divGDPRtext.innerHTML = "<div style='color: #000;width: 90%;margin-left: 25px;margin-bottom: 30px;margin-top: 15px;font-size:13px;line-height:20px;'>Mit dem Absenden willige ich in die Verarbeitung meiner angegebenen Daten zum Zweck der angegeben Aktion ein. Weitere Informationen finden Sie in unserer <a href='https://www.avaya.com/de/privacy/commitment/' target='_blank' style='color:#000000;text-decoration:underline;font-size: 13px;border-bottom: 0px solid;'>Datenschutzerklärung</a>. Sie können Sie Ihre E-Mail-Einstellungen <a href='https://news.avaya.com/global-subscription' target='_blank' style='color:#000000;text-decoration:underline;font-size: 13px;border-bottom: 0px solid;'>hier</a> verwalten.</div>";
...
if (SessCTA != null) {
	...
	if (pageURL.includes("/loesungen/customer-experience-and-contact-center/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-DE-CE";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-DE-CE";
		document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-DE-CE";
		document.getElementsByName("contentTitle1")[0].value = "Starten Sie jetzt, Ihre Kundenerfahrung zu transformieren";//Insert content title here
		document.getElementsByName("area_of_interest")[0].value = "CC";//Insert area of interest
	} else if (pageURL.includes("/loesungen/team-collaboration/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-DE-TEAM";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-DE-TEAM";
		document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-DE-TEAM";
		document.getElementsByName("contentTitle1")[0].value = "Werden Sie heute noch produktiver";//Insert content title here
		document.getElementsByName('area_of_interest')[0].value = "UC";
	} else if (pageURL.includes("/loesungen/digital-transformation/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-DE-DX";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-DE-DX";
		document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-DE-DX";
		document.getElementsByName("contentTitle1")[0].value = "Starten Sie Ihre Journey";//Insert content title here
		document.getElementsByName('area_of_interest')[0].value = "UC";
	} 
}
if (SessTAC != null) {
