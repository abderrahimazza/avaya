...
/*if (!!getCookie('FName')){
	...
	labelatt('fe121520');//hide EmailOptin label
	document.getElementById("fe121520").type = "hidden";
} else {
...
if (!!getCookie('LName')){
	...
	labelatt('fe121521');//hide EmailOptin label
	document.getElementById("fe121521").type = "hidden";
} else {
...
if (!!getCookie('country')){
	...
	labelatt('fe121525');//hide EmailOptin label
	document.getElementById("fe121525").type = "hidden";
} else {
...
labelatt('fe121527');//hide EmailOptin label
document.getElementById("fe121527").type = "hidden"; //EmailOptin is text field to hide this field
...
fe121520.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe121521.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe121522.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe121522.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "Une adresse e-mail valide est requise"});
fe121525.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
  ...
  console.log(emailFieldKF);
       ...
       $(function() {
                ...
                if( emailFieldKF != "")                {
                    ...
                    if(emailDomain != 'avaya.com1' && emailDomain != 'portent.com') {
...
//GA Script
document.getElementById('form3842').addEventListener(
