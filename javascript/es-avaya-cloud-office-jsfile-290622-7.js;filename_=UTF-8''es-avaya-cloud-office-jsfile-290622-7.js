...
pInstruct.innerHTML = "<font style='color: #313133;font-weight: 500;font-size:12px'><span style='color: #da291c; font-size: 12px;'>*</span> Campos Obligatorios</font>";
...
label.innerHTML = "Sí, también acepto recibir correos electrónicos de marketing de Avaya.";
var divGDPRtext = document.createElement("div");
divGDPRtext.id="gdprtext";
divGDPRtext.innerHTML = "<div style='color: #313133;width: 95%;margin-left: 5px;margin-bottom: 10px;margin-top: 15px;font-size:12px;line-height:20px;' class='formStatement'>Al enviar este formulario, acepto que mi información se procese en la base de datos de Avaya para el propósito mencionado anteriormente. Consulte nuestra <a href='https://www.avaya.com/es/privacy/website/' class='formStatLink' target='_blank' style='text-decoration:underline;font-size: 12px;border-bottom: 0px solid;color:#1B77AF;'>Declaración de privacidad</a> para obtener más detalles o administre sus <a href='https://news.avaya.com/global-subscription' class='formStatLink' target='_blank' style='text-decoration:underline;font-size: 12px;border-bottom: 0px solid;color: #1B77AF;'>preferencias de correo electrónico</a> en cualquier momento.</div>";
...
/*vUsingUCSolutionYes.onclick = function(){
		...
		fe88115.enable();
		fe88115.add( Validate.Presence, { failureMessage: "Este campo es requerido" } );	
...
document.getElementById("fe104340").type = "hidden"; //EmailOptin is text field to hide this field
...
/*if (document.getElementById('formElement8')){
	...
	if (document.getElementById('fe104320')){
		var div71a = document.getElementById('fe104320');
...
if (document.getElementById('formElement8')){
	...
	var checkboxfields = document.getElementById("fe104320").innerHTML;
...
document.getElementsByName("first_name")[0].setAttribute("aria-label", "Nombre");
document.getElementsByName("last_name")[0].setAttribute("aria-label", "Apellido");
document.getElementsByName("email")[0].setAttribute("aria-label", "Correo Electrónico");
document.getElementsByName("phone")[0].setAttribute("aria-label", "Teléfono");
document.getElementsByName("company_name")[0].setAttribute("aria-label", "Empresa");
document.getElementsByName("employees_total_range")[0].setAttribute("aria-label", "¿Cuántos empleados tiene su empresa?");
document.getElementsByName("country")[0].setAttribute("aria-label", "País");
document.getElementsByName("AreYouCurrentAvayaCustomer")[0].setAttribute("aria-label", "Sí");
document.getElementsByName("AreYouCurrentAvayaCustomer")[1].setAttribute("aria-label", "No");
document.getElementsByName("comments")[0].setAttribute("aria-label", "Mensaje");
...
function detect_ccode(){
		var strUser=document.getElementsByName("country")[0].value;
				...
				if(strUser=="United States" || strUser=="Canada"){					
					...
					if(strUser=="United States"){
						var countryO = ['Seleccione…','Alaska','Alabama','Arkansas','Arizona','California','Colorado','Connecticut','District of Columbia','Delaware','Florida','Georgia','Hawaii','Iowa','Idaho','Illinois','Indiana','Kansas','Kentucky','Louisiana','Massachusetts','Maryland','Maine','Michigan','Minnesota','Missouri','Mississippi','Montana','North Carolina','North Dakota','Nebraska','New Hampshire','New Jersey','New Mexico','Nevada','New York','Ohio','Oklahoma','Oregon','Pennsylvania','Puerto Rico','Rhode Island','South Carolina','South Dakota','Tennessee','Texas','Utah','Virginia','Vermont','Washington','Wisconsin','West Virginia','Wyoming'];
						...
						var countryO = ['Seleccione…','Alberta','APO','British Columbia','Manitoba','New Brunswick','Newfoundland','Newfoundland and Labrador','Northwest Terr.','Northwest Territories','Nova Scotia','Nunavut','Ontario','Prince Edward Island','Quebec','Saskatchewan','Yukon Territory'];
					...
					var fe104319 = new LiveValidation("fe104319", {validMessage: "", onlyOnBlur: true});
					fe104319.enable();
					fe104319.add(Validate.Presence, {failureMessage:"Este campo es requerido"});
				} else {
					$("#formElement7").slideUp();
					var fe104319 = new LiveValidation('fe104319');
					fe104319.disable();
				}	
	}
...
fe104312.add(Validate.Presence, {failureMessage:"Este campo es requerido"});
fe104313.add(Validate.Presence, {failureMessage:"Este campo es requerido"});
fe104314.add(Validate.Presence, {failureMessage:"Este campo es requerido"});
fe104314.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "Por favor inserte una dirección valida de e-mail"});
fe104315.add(Validate.Presence, {failureMessage:"Este campo es requerido"});
fe104316.add(Validate.Presence, {failureMessage:"Este campo es requerido"});
fe104317.add(Validate.Presence, {failureMessage:"Este campo es requerido"});
fe104318.add(Validate.Presence, {failureMessage:"Este campo es requerido"});
var dom8 = document.querySelectorAll('#form3534 [name="AreYouCurrentAvayaCustomer"]');var fe104320 = new LiveValidation(dom8, {validMessage: "", onlyOnBlur: false, wait: 300, insertAfterWhatNode :this.getParentElement(dom8), isGroup: true}, true);
fe104320.add(Validate.Presence, {failureMessage:"Este campo es requerido"});
...
var div14a = document.getElementById('fe104349');
...
/*function OnLoadCreateFields(){
	var divcontainer1 = document.getElementById('formElement8');
	var divcontainer1a = document.getElementById('formElement8').children[1].children[0].children[0].children[0].children[1];
	var divcontainer1b = document.getElementById('formElement8').children[1].children[0].children[0].children[0];
	divcontainer1b.setAttribute("style","display: table;");
	var textfield1 = document.createElement('div');
	textfield1.setAttribute("id","formElement8a");
	...
	insertAfter(textfield1, divcontainer1);*/
	
	/*var textfield2 = document.createElement('div');
	textfield2.setAttribute("id","formElement9a");
	textfield2.setAttribute("height","0");
	textfield2.setAttribute("style","padding: 0px 5px 0px 0px;height:0px;margin: 0px 0px 0px 0px;");
	textfield2.innerHTML = "<input type='text' id='UsingUCSolutionValid' name='UsingUCSolutionValid' value='' style='width: 1px; height: 1px; outline: none; border: none; background: transparent; padding: 0;'>";
	divcontainer2 = document.getElementById('formElement9');
	insertAfter(textfield2, divcontainer2);
	
	var divcontainer2 = document.getElementById('formElement9');
	var divcontainer2a = document.getElementById('formElement9').children[1].children[0].children[0].children[0].children[1];
	var divcontainer2b = document.getElementById('formElement9').children[1].children[0].children[0].children[0];
	...
	AreYouCurrentAvayaCustomerValid.add( Validate.Presence, { failureMessage: "Este campo es requerido" } );
	AreYouCurrentAvayaCustomerValid.enable();*/
	
	/*var UsingUCSolutionValid = new LiveValidation( "UsingUCSolutionValid", { validMessage: "", onlyOnBlur: true });
	UsingUCSolutionValid.add( Validate.Presence, { failureMessage: "Este campo es requerido" } );
	UsingUCSolutionValid.enable();*/
...
//var subonclick1= document.getElementsByClassName("submit-button")[0];
...
css = css+ '#fe104320{background-color: #ffffff !important}';
...
/*GA*/
 ...
 document.getElementById('form3534').addEventListener(
 ...
 document.getElementById('GACLIENTID').value = clientId;
  ...
  document.getElementById("fe104349").setAttribute("aria-label", "Enviar"); 
