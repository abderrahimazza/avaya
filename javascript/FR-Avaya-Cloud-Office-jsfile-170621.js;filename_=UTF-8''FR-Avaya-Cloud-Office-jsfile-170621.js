...
divGDPRtext.innerHTML = "<div style='color: #000;width: 90%;margin-left: 25px;margin-bottom: 10px;margin-top: 15px;font-size:13px;line-height:20px;'>En soumettant ce formulaire, j'accepte que mes informations soient traitées dans la base de données Avaya, dans le but mentionné ci-dessus. Consultez notre <a href='https://www.avaya.com/fr/privacy/website/' target='_blank' style='color:#CC0000;font-size:13px;line-height:20px;text-decoration:underline;'>déclaration de confidentialité</a> pour plus de détails ou gérez vos <a href='https://news.avaya.com/global-subscription' target='_blank' style='color:#CC0000;font-size:13px;line-height:20px;text-decoration:underline;'>préférences de courrier électronique</a> quand vous le souhaitez.</div>";
...
/*vUsingUCSolutionYes.onclick = function(){
		...
		fe88115.enable();
		fe88115.add( Validate.Presence, { failureMessage: "Champ obligatoire" } );	
...
document.getElementById("fe97738").type = "hidden"; //EmailOptin is text field to hide this field
...
if (document.getElementById('formElement8')){
	...
	if (document.getElementById('fe97718')){
		var div71a = document.getElementById('fe97718');
...
function detect_ccode(){
		var strUser=document.getElementsByName("country")[0].value;
				...
				if(strUser=="United States")
				{
					...
					var fe97717 = new LiveValidation("fe97717", {validMessage: "", onlyOnBlur: true});
					fe97717.enable();
					fe97717.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
				}
				else
				{
					$("#formElement7").slideUp();
					var fe97717 = new LiveValidation('fe97717');
					fe97717.disable();
				}
...
fe97710.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe97711.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe97712.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe97712.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "Une adresse e-mail valide est requise"});
fe97713.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe97714.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe97715.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe97716.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
...
var div14a = document.getElementById('fe97743');
		div14a.setAttribute("style", "color:#FFF;background-color:#DA291C;font-weight: 400;font-family: 'HCo Gotham SSm';font-size: 14px;line-height: 24px;display:block;");
...
function OnLoadCreateFields(){
	...
	UsingUCSolutionValid.add( Validate.Presence, { failureMessage: "Champ obligatoire" } );
...
//		if (labels[i].getAttribute('for').indexOf('Yes') > -1) {
//			labels[i].innerHTML = "Oui";
//		}
//		if (labels[i].getAttribute('for').indexOf('No') > -1) {
//			labels[i].innerHTML = "Non";
//		}
//	
//	}
...
var labels = document.getElementsByTagName('label');
    for(var i = 0; i < labels.length; i ++) {
		...
		if (attr.indexOf('Yes') > -1) {
			labels[i].innerHTML = "Oui";
		}
		if (attr.indexOf('No') > -1) {
			labels[i].innerHTML = "Non";
		}
	
	}
document.getElementsByName('employees_total_range')[0].options[0].innerHTML = "-- Sélectionner --";


subonclick= document.getElementById("fe97743");
...
/*GA*/
 ...
 document.getElementById('form3382').addEventListener(
