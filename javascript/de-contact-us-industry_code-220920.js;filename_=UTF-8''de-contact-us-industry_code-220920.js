...
/*** GDPR Optin / Optout Code **************/
			...
			function checkOptin(){
				...
				if(checkbox1.checked == true){
					...
					document.getElementsByName("emailOptinSource1")[0].value = "DEU-OWCS-contact-us";
...
labelatt('fe86469');//hide EmailOptin label
...
document.getElementById("fe86469").type = "hidden"; //EmailOptin is text field to hide this field
...
divGDPRtext.innerHTML = "<div style='color: #000;width: 90%;margin-left: 25px;margin-bottom: 30px;margin-top: 15px;font-size:13px;line-height:20px;'>Mit dem Absenden willige ich in die Verarbeitung meiner angegebenen Daten zum Zweck der angegeben Aktion ein. Weitere Informationen finden Sie in unserer <a href='https://www.avaya.com/de/privacy/website/' target='_blank' style='color:#DA291C;text-decoration:underline;font-size: 13px;border-bottom: 0px solid;'>Datenschutzerklärung</a>. Sie können Sie Ihre E-Mail-Einstellungen <a href='https://news.avaya.com/global-subscription' target='_blank' style='color:#DA291C;text-decoration:underline;font-size: 13px;border-bottom: 0px solid;'>hier</a> verwalten.</div>";
...
document.getElementsByName("contentTitle1")[0].value = "Sprechen Sie mit einem Experten";//Insert content title here
...
//document.getElementById("field7").value = "Germany";
...
var textareafield = document.getElementsByName('contactComments')[0];
var textareaF = document.getElementsByName('contactComments')[0].value;
//textareafield.onclick=myfunction(
document.getElementsByName('contactComments')[0].value = textareaF.trim();



//for Validation
fe86441.add(Validate.Presence, {failureMessage:"Mussfeld"});
fe86442.add(Validate.Presence, {failureMessage:"Mussfeld"});
fe86443.add(Validate.Presence, {failureMessage:"Mussfeld"});
fe86443.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "Es wird eine gültige E-Mail Adresse benötigt"});
fe86444.add(Validate.Presence, {failureMessage:"Mussfeld"});
fe86445.add(Validate.Presence, {failureMessage:"Mussfeld"});
fe86448.add(Validate.Presence, {failureMessage:"Mussfeld"});
fe86449.add(Validate.Presence, {failureMessage:"Mussfeld"});
...
if (SessCTA != null) {
	...
	if (pageURL.includes("/loesungen/healthcare/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-DE-HC";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-DE-HC";
		document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-DE-HC";
	} else if (pageURL.includes("/loesungen/hospitality/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-DE-HOSP";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-DE-HOSP";
		document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-DE-HOSP";
	} else if (pageURL.includes("/loesungen/government-and-public-safety/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-DE-GOV";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-DE-GOV";
		document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-DE-GOV";
	} else if (pageURL.includes("/loesungen/education/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-DE-EDU";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-DE-EDU";
		document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-DE-EDU";
	} else if (pageURL.includes("/loesungen/financial-services/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-DE-FIN";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-DE-FIN";
		document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-DE-FIN";
	} else if (pageURL.includes("/loesungen/sports-and-entertainment/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-DE-ENT";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-DE-ENT";
		document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-DE-ENT";
	} 
}
if (SessTAC != null) {
	console.log(SessTAC);
...
subonclick= document.getElementById("fe86479");
...
/*GA*/
 ...
 document.getElementById('form3049').addEventListener(
