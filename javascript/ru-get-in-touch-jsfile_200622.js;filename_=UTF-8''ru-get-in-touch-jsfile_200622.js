...
labelatt('fe85755');//hide EmailOptin label
...
document.getElementById("fe85755").type = "hidden"; //EmailOptin is text field to hide this field
...
pInstruct.innerHTML = "<font style='color: #313133;font-weight: 500;font-size:12px'>Поля, помеченные звездочкой <span style='color: #da291c; font-size: 12px;'>*</span> обязательны к заполнению.</font>";
...
//label.innerHTML = "Да, я также даю своё согласие на получение маркетинговой рассылки от Avaya.";
label.appendChild(document.createTextNode("Да, я также даю своё согласие на получение маркетинговой рассылки от Avaya."));
label.setAttribute("for","optin");
var divGDPRtext = document.createElement("div");
divGDPRtext.id="gdprtext";
divGDPRtext.innerHTML = "<div style='color: #313133;width: 95%;margin-left: 5px;margin-bottom: 30px;margin-top: 15px;font-size:12px;line-height:20px;' class='formStatement'>Заполняя данную форму, я даю свое согласие Avaya на обработку моих персональных данных в соответствии с вышеуказанным запросом. Вы можете ознакомиться с <a href='https://www.avaya.com/ru/privacy/website/' class='formStatLink' target='_blank' style='text-decoration:underline;font-size: 12px;border-bottom: 0px solid;color:#1B77AF;'>Положением о конфиденциальности</a> или изменить <a href='https://news.avaya.com/global-subscription' class='formStatLink' target='_blank' style='text-decoration:underline;font-size: 12px;border-bottom: 0px solid;color: #1B77AF;'>Условия новостной рассылки</a> в любое время.</div>";
...
document.getElementById("optin").setAttribute("aria-label", "Да, я также даю своё согласие на получение маркетинговой рассылки от Avaya.");
...
subonclick= document.getElementById("fe85761");
...
//for Validation
fe85728.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
fe85729.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
fe85730.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
fe85730.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "Требуется действительный адрес электронной почты"});
fe85731.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
fe85732.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
fe85733.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
fe85734.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
fe85735.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
...
/*GA*/
 ...
 document.getElementById('form3024').addEventListener(
