...
for (let element of document.getElementsByClassName("elq-required")){
   element.style.display="none";
}
//document.getElementsByName('elq-required').style.display = "none";
...
/*** GDPR Optin / Optout Code **************/
			...
			function checkOptin(){
				...
				if(checkbox1.checked == true){
					...
					document.getElementsByName("emailOptinSource1")[0].value = "WEB-GET-EN-SMB-CC";
...
vUsingCCSolutionYes.onclick = function(){
	...
	//if (document.getElementsByName('UsingCCSolution')[0].value == "Yes"){
		...
		var fe87584 = new LiveValidation( "fe87584", { validMessage: "", onlyOnBlur: true });
		fe87584.enable();
		fe87584.add( Validate.Presence, { failureMessage: "This field is required" } );	
	//} else {		
...
document.getElementById("fe87602").type = "hidden"; //EmailOptin is text field to hide this field
...
if (document.getElementById('formElement7')){
	...
	if (document.getElementById('fe87582')){
		var div71a = document.getElementById('fe87582');
		var div71b = div71a.getElementsByTagName('div');
		console.log("div71b  === "+div71b.length);
		div71b[0].setAttribute("style", "width: 60px !important; height: 45px;display: table-cell;vertical-align: top; padding-top:10px;");
		div71b[1].setAttribute("style", "width: 60px !important; height: 45px;display: table-cell;vertical-align: top; padding-top:10px;");
...
if (document.getElementById('formElement8')){
	...
	if (document.getElementById('fe87583')){
		var div81a = document.getElementById('fe87583');
...
label.innerHTML = "Yes, I also agree to receive marketing emails from Avaya.";
...
document.getElementsByName('AgentsNeeded')[0].setAttribute("placeholder"," ");
document.getElementsByName('NameYourCurrentCCSolution')[0].setAttribute("placeholder"," ");
document.getElementsByName('PartnerOrSalesAgent')[0].setAttribute("placeholder"," ");
...
fe87575.add(Validate.Presence, {failureMessage:"This field is required"});
fe87576.add(Validate.Presence, {failureMessage:"This field is required"});
fe87577.add(Validate.Presence, {failureMessage:"This field is required"});
fe87577.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "A valid email address is required"});
fe87578.add(Validate.Presence, {failureMessage:"This field is required"});
fe87579.add(Validate.Presence, {failureMessage:"This field is required"});
fe87580.add(Validate.Presence, {failureMessage:"This field is required"});
fe87581.add(Validate.Presence, {failureMessage:"This field is required"});
fe87582.add(Validate.Presence, {failureMessage:"This field is required"});
fe87583.add(Validate.Presence, {failureMessage:"This field is required"});
...
x.style.backgroundColor = "#1B77AF";
//x.style.backgroundColor = "#DA291C";
x.style.marginTop = "15px";
x.style.marginLeft = "auto";
x.style.marginright = "auto";
x.style.display = "block";
var div14a = document.getElementById('fe87609');
		div14a.setAttribute("style", "color:#FFF;background-color:#1B77AF;font-weight: 400;font-size: 14px;line-height: 24px;display:block;");
...
/*function OnLoadCreateFields(){
	...
	AreYouCurrentAvayaCustomerValid.add( Validate.Presence, { failureMessage: "This field is required" } );
	...
	UsingCCSolutionValid.add( Validate.Presence, { failureMessage: "This field is required" } );
...
if (getUrlVar("TAC") != ""){
	...
	document.getElementsByName("tactic_code")[0].value = "WEB-GET-EN-SMB-CC";
}
...
css = css+ '.av-form-columns .elq-form .LV_valid_field { border-color: #1B77AF }';
...
css = css+ '.av-form-columns .elq-form select:hover { border-color: #1B77AF !important}';
css = css+ '.av-form-columns .elq-form textarea:hover{ border-color: #1B77AF !important}';
css = css+ '.av-form-columns .elq-form label{margin-bottom: 5px;}';
css = css+ '.av-form-columns .elq-form input, .av-form-columns .elq-form select, .av-form-columns .elq-form textarea{background-color: #f1f1f3;}';//field background color
css = css+ '.av-form-columns .elq-form input:focus, .av-form-columns .elq-form select:focus, .av-form-columns .elq-form textarea:focus{background-color: #ffffff;}';
css = css+ '.av-form-columns .form-text p {color:#313133}';
css = css+ '.LV_valid_field { border-color: #1B77AF;background-color: #f1f1f3 !important}';
css = css+ '.av-form-columns .elq-form label { font-family: "Noto Sans JP";font-size: 12px;line-height: 20px !important;color: #313133;}';
css = css+ '.av-form-columns .grid-layout-col .form-element-layout {padding-bottom: 0px !important;margin-bottom: 15px !important;}';
css = css+ '.av-form-columns .elq-form label{width: 100%;font-family: "Noto Sans JP";}';
css = css+ '.av-form-columns .extBoth{clear:both !important}';
css = css+ '.av-form-columns .elq-form .LV_validation_message{margin:0px !important}';
css = css+ '#fe87582{background-color: #ffffff !important}';
css = css+ '#fe87583{background-color: #ffffff !important}';
...
css = css+ '.av-form-columns .elq-form input:-webkit-autofill, .av-form-columns .elq-form input:-webkit-autofill:hover, .av-form-columns .elq-form input:-webkit-autofill:focus, .av-form-columns .elq-form input:-webkit-autofill:active { background-color: #ffffff !important; -webkit-box-shadow: 0 0 0 30px white inset !important;}';
...
/*GA*/
 ...
 document.getElementById('form3085').addEventListener(
