...
labelatt('fe85433');//hide EmailOptin label
...
document.getElementById("fe85433").type = "hidden"; //EmailOptin is text field to hide this field
...
label.appendChild(document.createTextNode("Oui, j'accepte également de recevoir des courriers électroniques marketing d'Avaya."));
...
var SessTAC = getCookie('tac');
		if (SessCTA != null) {
			...
			document.getElementsByName("cta_code")[0].value = "WEB-GET-FR";
		}
		if (SessTAC != null) {
			console.log(SessTAC);
			...
			document.getElementsByName("tactic_code")[0].value = "WEB-GET-FR";
		}*/
...
//document.getElementsByName('email')[0].addEventListener("blur", popFormFieldsKF1, true);
//popFormFieldsKF1();
/*(function() {
...
subonclick= document.getElementById("fe85439");
...
//for Validation
fe85408.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe85409.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe85410.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe85410.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "Une adresse e-mail valide est requise"});
fe85411.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe85412.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe85413.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe85414.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe85415.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
...
/*GA*/
 ...
 document.getElementById('form3014').addEventListener(
