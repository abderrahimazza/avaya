...
/*** GDPR Optin / Optout Code **************/
			...
			function checkOptin(){
				...
				if(checkbox1.checked == true){
					...
					document.getElementsByName("emailOptinSource1")[0].value = "9USA-SUB-DG-LP-CME-JP";
...
labelatt('fe96805');//hide EmailOptin label
...
document.getElementById("fe96805").type = "hidden";//EmailOptin is text field to hide this field
...
divGDPRtext.innerHTML = "<div style='color: #000;width: 90%;margin-left: 25px;margin-bottom: 30px;margin-top: 15px;font-size:13px;line-height:20px;font-family: HCo Gotham SSm;'>このフォームを送ることでご自分の個人情報をアバイアのデーターベースにて上記の目的で 使用されることにご同意いただいたことになります。アバイアのプライバシーステイトメントは<a href='https://www.avaya.com/jp/privacy/website/' target='_blank' style='color:#DA291C;text-decoration:underline;font-family: HCo Gotham SSm;'>こちら</a>でご確認いただけます。受信解除やメールの設定は<a href='https://news.avaya.com/global-subscription' target='_blank' style='color:#DA291C;text-decoration:underline;font-family: HCo Gotham SSm;'>こちら</a>からいつでも変更可能です。</div>";
...
document.getElementsByName("contentTitle1")[0].value = "Avaya IX Subscriptionの詳細を見る";//Insert content title here
...
//for Validation
fe96791.add(Validate.Presence, {failureMessage:"会社名をご記入ください."});
fe96788.add(Validate.Presence, {failureMessage:"お名前をご記入ください."});
fe96789.add(Validate.Presence, {failureMessage:"メールアドレスをご記入ください."});
fe96789.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "メールアドレスをご記入ください."});
fe96790.add(Validate.Presence, {failureMessage:"電話番号をご記入ください"});
...
/*GA*/
 ...
 document.getElementById('form3357').addEventListener(
