...
/*** GDPR Optin / Optout Code **************/
			...
			function checkOptin(){
				...
				if(checkbox1.checked == true){
					...
					document.getElementsByName("emailOptinSource1")[0].value = "9USA-SUB-DG-LP-CME-IT";
...
labelatt('fe96751');//hide EmailOptin label
...
document.getElementById("fe96751").type = "hidden";//EmailOptin is text field to hide this field
...
divGDPRtext.innerHTML = "<div style='color: #000;width: 90%;margin-left: 25px;margin-bottom: 30px;margin-top: 15px;font-size:13px;line-height:20px;'>Con l’inoltro di questo modulo, consento ad Avaya di processare le mie informazioni nel suo database per gli scopi sopra menzionati. Vedi il nostro <a href='https://www.avaya.com/it/privacy/website/' target='_blank' style='color:#DA291C;text-decoration:underline;'>Privacy Statement</a> per ulteriori dettagli o gestisci le tue <a href='https://news.avaya.com/global-subscription' target='_blank' style='color:#DA291C;text-decoration:underline;'>Preferenze Email</a> in qualsiasi momento.</div>";
...
document.getElementsByName("contentTitle1")[0].value = "Scopri di più su  Avaya IX Subscription";//Insert content title here
...
//for Validation
fe96733.add(Validate.Presence, {failureMessage:"Questo campo è obbligatorio"});
fe96734.add(Validate.Presence, {failureMessage:"Questo campo è obbligatorio"});
fe96735.add(Validate.Presence, {failureMessage:"Questo campo è obbligatorio"});
fe96735.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "È necessario un indirizzo email valido"});
fe96736.add(Validate.Presence, {failureMessage:"Questo campo è obbligatorio"});
fe96737.add(Validate.Presence, {failureMessage:"Questo campo è obbligatorio"});
fe96738.add(Validate.Presence, {failureMessage:"Questo campo è obbligatorio"});
...
/*GA*/
 ...
 document.getElementById('form3355').addEventListener(
