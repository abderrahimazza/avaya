...
/*** GDPR Optin / Optout Code **************/
			...
			function checkOptin(){
				...
				if(checkbox1.checked == true){
					...
					document.getElementsByName("emailOptinSource1")[0].value = "9USA-SUB-DG-LP-CME-FR";
...
labelatt('fe96672');//hide EmailOptin label
...
document.getElementById("fe96672").type = "hidden";//EmailOptin is text field to hide this field
...
divGDPRtext.innerHTML = "<div style='color: #000;width: 90%;margin-left: 25px;margin-bottom: 30px;margin-top: 15px;font-size:13px;line-height:20px;'>En soumettant ce formulaire, j'accepte que mes informations soient traitées dans la base de données Avaya, dans le but mentionné ci-dessus. Consultez notre <a href='https://www.avaya.com/fr/privacy/website/' target='_blank' style='color:#DA291C;text-decoration:underline;'>déclaration de confidentialité</a> pour plus de détails ou gérez vos <a href='https://news.avaya.com/global-subscription' target='_blank' style='color:#DA291C;text-decoration:underline;'>préférences de courrier électronique</a> quand vous le souhaitez.</div>";
...
document.getElementsByName("contentTitle1")[0].value = "En savoir plus sur Avaya IX Subscription";//Insert content title here
...
//for Validation
fe96654.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe96655.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe96656.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe96656.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "Une adresse e-mail valide est requise"});
fe96657.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe96658.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe96659.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
...
/*GA*/
 ...
 document.getElementById('form3352').addEventListener(
