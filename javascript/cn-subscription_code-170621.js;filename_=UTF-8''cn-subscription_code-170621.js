...
/*** GDPR Optin / Optout Code **************/
			...
			function checkOptin(){
				...
				if(checkbox1.checked == true){
					...
					document.getElementsByName("emailOptinSource1")[0].value = "9USA-SUB-DG-LP-CME-CN";
...
labelatt('fe94944');//hide EmailOptin label
...
document.getElementById("fe94944").type = "hidden";//EmailOptin is text field to hide this field
...
label.appendChild(document.createTextNode('是的，我也同意接收Avaya营销邮件。'));
var divGDPRtext = document.createElement("div");
divGDPRtext.id="gdprtext";
divGDPRtext.innerHTML = "<div style='color: #000;width: 90%;margin-left: 25px;margin-bottom: 30px;margin-top: 15px;font-size:13px;line-height:20px;font-family: HCo Gotham SSm;'>通过提交此表格，我同意将我的信息在Avaya数据库中进行处理，以达到上述目的。有关更多详细信息，请参阅我们的<a href='https://www.avaya.com/cn/privacy/website/' target='_blank' style='color:#DA291C;text-decoration:underline;font-family: HCo Gotham SSm;'>隐私声明</a>，或随时管理您的<a href='https://news.avaya.com/global-subscription' target='_blank' style='color:#DA291C;text-decoration:underline;font-family: HCo Gotham SSm;'>电子邮件首选项</a>。</div>";
...
document.getElementsByName("contentTitle1")[0].value = "了解更多Avaya IX 订阅式服务";//Insert content title here
...
//for Validation
fe94927.add(Validate.Presence, {failureMessage:"这是必填栏"});
fe94925.add(Validate.Presence, {failureMessage:"这是必填栏"});
fe94928.add(Validate.Presence, {failureMessage:"这是必填栏"});
fe94928.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "请填写有效的公司电子邮件地址"});
fe94929.add(Validate.Presence, {failureMessage:"这是必填栏"});
fe94930.add(Validate.Presence, {failureMessage:"这是必填栏"});
fe94931.add(Validate.Presence, {failureMessage:"这是必填栏"});
...
/*GA*/
 ...
 document.getElementById('form3309').addEventListener(
