...
/*if (!!getCookie('FName')){
	...
	labelatt('fe121581');//hide EmailOptin label
	document.getElementById("fe121581").type = "hidden";
} else {
...
if (!!getCookie('LName')){
	...
	labelatt('fe121582');//hide EmailOptin label
	document.getElementById("fe121582").type = "hidden";
} else {
...
if (!!getCookie('country')){
	...
	labelatt('fe121586');//hide EmailOptin label
	document.getElementById("fe121586").type = "hidden";
} else {
...
labelatt('fe121588');//hide EmailOptin label
document.getElementById("fe121588").type = "hidden"; //EmailOptin is text field to hide this field
...
fe121581.add(Validate.Presence, {failureMessage:"Questo campo è obbligatorio"});
fe121582.add(Validate.Presence, {failureMessage:"Questo campo è obbligatorio"});
fe121583.add(Validate.Presence, {failureMessage:"Questo campo è obbligatorio"});
fe121583.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "È necessario un indirizzo email valido"});
fe121586.add(Validate.Presence, {failureMessage:"Questo campo è obbligatorio"});
...
//GA Script
document.getElementById('form3843').addEventListener(
