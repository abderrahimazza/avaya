...
document.getElementById("fe88267").type = "hidden"; //EmailOptin is text field to hide this field
...
/*if (document.getElementById('formElement8')){
	...
	if (document.getElementById('fe88247')){
		var div71a = document.getElementById('fe88247');
...
if (document.getElementById('formElement8')){
	...
	var checkboxfields = document.getElementById("fe88247").innerHTML;
...
document.getElementById("form3108").setAttribute("aria-label", "An Avaya solutions specialist will contact you about Avaya Cloud Office.");
...
document.getElementsByName("employees_total_range")[0].setAttribute("aria-label", "Number of Employees");
document.getElementsByName("country")[0].setAttribute("aria-label", "Country");
document.getElementsByName("AreYouCurrentAvayaCustomer")[0].setAttribute("aria-label", "Yes");
document.getElementsByName("AreYouCurrentAvayaCustomer")[1].setAttribute("aria-label", "No");
document.getElementsByName("comments")[0].setAttribute("aria-label", "Comments");
...
function detect_ccode(){
		var strUser=document.getElementsByName("country")[0].value;
				...
				if(strUser=="United States")
				{
					...
					var fe88246 = new LiveValidation("fe88246", {validMessage: "", onlyOnBlur: true});
					fe88246.enable();
					fe88246.add(Validate.Presence, {failureMessage:"This field is required"});
				}
				else
				{
					$("#formElement7").slideUp();
					var fe88246 = new LiveValidation('fe88246');
					fe88246.disable();
				}
...
fe88240.add(Validate.Presence, {failureMessage:"This field is required"});
fe88241.add(Validate.Presence, {failureMessage:"This field is required"});
fe88242.add(Validate.Presence, {failureMessage:"This field is required"});
fe88242.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "A valid email address is required"});
fe88243.add(Validate.Presence, {failureMessage:"This field is required"});
fe88244.add(Validate.Presence, {failureMessage:"This field is required"});
fe88273.add(Validate.Presence, {failureMessage:"This field is required"});
fe88245.add(Validate.Presence, {failureMessage:"This field is required"});
var dom8 = document.querySelectorAll('#form3108 [name="AreYouCurrentAvayaCustomer"]');var fe88247 = new LiveValidation(dom8, {validMessage: "", onlyOnBlur: false, wait: 300, insertAfterWhatNode :this.getParentElement(dom8), isGroup: true}, true);
fe88247.add(Validate.Presence, {failureMessage:"This field is required"});
...
var div14a = document.getElementById('fe88272');
...
/*function OnLoadCreateFields(){
	...
	//UsingUCSolutionValid.add( Validate.Presence, { failureMessage: "This field is required" } );
...
subonclick= document.getElementById("fe88272");
...
/*GA*/
 ...
 document.getElementById('form3108').addEventListener(
...
document.getElementById("fe88272").setAttribute("aria-label", "Submit"); 
