...
/*if (!!getCookie('FName')){
	...
	labelatt('fe121642');//hide EmailOptin label
	document.getElementById("fe121642").type = "hidden";
} else {
...
if (!!getCookie('LName')){
	...
	labelatt('fe121643');//hide EmailOptin label
	document.getElementById("fe121643").type = "hidden";
} else {
...
if (!!getCookie('country')){
	...
	labelatt('fe121647');//hide EmailOptin label
	document.getElementById("fe121647").type = "hidden";
} else {
...
labelatt('fe121649');//hide EmailOptin label
document.getElementById("fe121649").type = "hidden"; //EmailOptin is text field to hide this field
...
fe121642.add(Validate.Presence, {failureMessage:"Campo obrigatório"});
fe121643.add(Validate.Presence, {failureMessage:"Campo obrigatório"});
fe121644.add(Validate.Presence, {failureMessage:"Campo obrigatório"});
fe121644.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "Endereço de e-mail válido"});
fe121647.add(Validate.Presence, {failureMessage:"Campo obrigatório"});
  ...
  console.log(emailFieldKF);
       ...
       $(function() {
                ...
                if( emailFieldKF != "")                {
                    ...
                    if(emailDomain != 'avaya1.com' && emailDomain != 'portent.com') {
...
//GA Script
document.getElementById('form3844').addEventListener(
