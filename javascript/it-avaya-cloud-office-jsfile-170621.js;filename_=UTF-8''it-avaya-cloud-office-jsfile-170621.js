...
divGDPRtext.innerHTML = "<div style='color: #000;width: 90%;margin-left: 25px;margin-bottom: 10px;margin-top: 15px;font-size:13px;line-height:20px;'>Con l’inoltro di questo modulo, consento ad Avaya di processare le mie informazioni nel suo database per gli scopi sopra menzionati. Vedi il nostro <a href='https://www.avaya.com/it/privacy/website/' target='_blank' style='color:#DA291C;text-decoration:underline;font-size: 13px;border-bottom: 0px solid;'>Privacy Statement</a> per ulteriori dettagli o gestisci le tue <a href='https://news.avaya.com/global-subscription' target='_blank' style='color:#DA291C;text-decoration:underline;font-size: 13px;border-bottom: 0px solid;'>Preferenze Email</a> in qualsiasi momento.</div>";
...
document.getElementById("fe104659").type = "hidden"; //EmailOptin is text field to hide this field
...
if (document.getElementById('formElement8')){
	...
	if (document.getElementById('fe104639')){
		var div71a = document.getElementById('fe104639');
...
function detect_ccode(){
		var strUser=document.getElementsByName("country")[0].value;
				...
				if(strUser=="United States")
				{
					...
					var fe104638 = new LiveValidation("fe104638", {validMessage: "", onlyOnBlur: true});
					fe104638.enable();
					fe104638.add(Validate.Presence, {failureMessage:"Questo campo è obbligatorio"});
				}
				else
				{
					$("#formElement7").slideUp();
					var fe104638 = new LiveValidation('fe104638');
					fe104638.disable();
				}
...
fe104631.add(Validate.Presence, {failureMessage:"Questo campo è obbligatorio"});
fe104632.add(Validate.Presence, {failureMessage:"Questo campo è obbligatorio"});
fe104633.add(Validate.Presence, {failureMessage:"Questo campo è obbligatorio"});
fe104633.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "È necessario un indirizzo email valido"});
fe104634.add(Validate.Presence, {failureMessage:"Questo campo è obbligatorio"});
fe104635.add(Validate.Presence, {failureMessage:"Questo campo è obbligatorio"});
fe104636.add(Validate.Presence, {failureMessage:"Questo campo è obbligatorio"});
fe104637.add(Validate.Presence, {failureMessage:"Questo campo è obbligatorio"});
...
var div14a = document.getElementById('fe104668');
...
function OnLoadCreateFields(){
	...
	AreYouCurrentAvayaCustomerValid.add( Validate.Presence, { failureMessage: "Questo campo è obbligatorio" } );
