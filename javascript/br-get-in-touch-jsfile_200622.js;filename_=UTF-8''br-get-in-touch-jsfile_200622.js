...
labelatt('fe85592');//hide EmailOptin label
...
document.getElementById("fe85592").type = "hidden"; //EmailOptin is text field to hide this field
...
pInstruct.innerHTML = "<font style='color: #313133;font-weight: 500;font-size:12px'><span style='color: #da291c; font-size: 12px;'>*</span> Todos os campos são obrigatórios.</font>";
...
divGDPRtext.innerHTML = "<div style='color: #313133;width: 95%;margin-left: 5px;margin-bottom: 30px;margin-top: 15px;font-size:12px;line-height:20px;' class='formStatement'>Ao submeter este formulário, estou de acordo que os meus dados sejam processados na base de dados da Avaya para o fim acima mencionado. Consulte a nossa <a href='https://www.avaya.com/br/privacy/website/' class='formStatLink' target='_blank' style='text-decoration:underline;font-size: 12px;border-bottom: 0px solid;color:#1B77AF;'>Declaração de Privacidade</a> para mais detalhes, ou configure em qualquer momento as suas <a href='https://news.avaya.com/global-subscription' class='formStatLink' target='_blank' style='text-decoration:underline;font-size: 12px;border-bottom: 0px solid;color: #1B77AF;'>preferências de email</a>.</div>";
...
document.getElementById("optin").setAttribute("aria-label", "Sim, concordo também em receber da Avaya emails promocionais.");
...
document.getElementsByName('contactComments')[0].value = textareaF.trim();*/
		...
		if (getUrlVar("CTA") != ""){
			...
			document.getElementsByName("cta_code")[0].value = "WEB-GET-BR";
		}
		
		if (getUrlVar("TAC") != ""){
			document.getElementsByName("tactic_code")[0].value = getUrlVar("TAC");
		} else {
			document.getElementsByName("tactic_code")[0].value = "WEB-GET-BR";
		}
...
subonclick= document.getElementById("fe85598");
...
//for Validation
fe85567.add(Validate.Presence, {failureMessage:"Campo obrigatório"});
fe85568.add(Validate.Presence, {failureMessage:"Campo obrigatório"});
fe85569.add(Validate.Presence, {failureMessage:"Campo obrigatório"});
fe85569.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "Endereço de e-mail válido"});
fe85570.add(Validate.Presence, {failureMessage:"Campo obrigatório"});
fe85571.add(Validate.Presence, {failureMessage:"Campo obrigatório"});
fe85572.add(Validate.Presence, {failureMessage:"Campo obrigatório"});
fe85573.add(Validate.Presence, {failureMessage:"Campo obrigatório"});
fe85574.add(Validate.Presence, {failureMessage:"Campo obrigatório"});
...
/*GA*/
 ...
 document.getElementById('form3019').addEventListener(
...
// check checkbox for optin / oupt out
			function checkOptin(){
				...
				if(checkbox1.checked == true){
					...
					document.getElementsByName("emailOptinSource1")[0].value = "WEB-GET-BR";
