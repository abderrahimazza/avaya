...
/*** GDPR Optin / Optout Code **************/
			...
			function checkOptin(){
				...
				if(checkbox1.checked == true){
					...
					document.getElementsByName("emailOptinSource1")[0].value = "BR-OWCS-contact-us";
...
labelatt('fe87078');//hide EmailOptin label
...
document.getElementById("fe87078").type = "hidden"; //EmailOptin is text field to hide this field
...
divGDPRtext.innerHTML = "<div style='color: #000;width: 90%;margin-left: 25px;margin-bottom: 30px;margin-top: 15px;font-size:13px;line-height:20px;'>Ao submeter este formulário, estou de acordo que os meus dados sejam processados na base de dados da Avaya para o fim acima mencionado. Consulte a nossa <a href='https://www.avaya.com/br/privacy/commitment/' target='_blank' style='color:#DA291C;text-decoration:underline;font-size: 13px;border-bottom: 0px solid;'>Declaração de Privacidade</a> para mais detalhes, ou configure em qualquer momento as suas <a href='https://news.avaya.com/global-subscription' target='_blank' style='color:#DA291C;text-decoration:underline;font-size: 13px;border-bottom: 0px solid;'>preferências de email</a>.</div>";
...
document.getElementsByName("contentTitle1")[0].value = "Fale com um especialista";//Insert content title here
...
//for Validation
fe87051.add(Validate.Presence, {failureMessage:"Este campo é obrigatório"});
fe87052.add(Validate.Presence, {failureMessage:"Este campo é obrigatório"});
fe87053.add(Validate.Presence, {failureMessage:"Este campo é obrigatório"});
fe87053.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "Um endereço de e-mail válido é necessário"});
fe87054.add(Validate.Presence, {failureMessage:"Este campo é obrigatório"});
fe87055.add(Validate.Presence, {failureMessage:"Este campo é obrigatório"});
fe87058.add(Validate.Presence, {failureMessage:"Este campo é obrigatório"});
		...
		if (SessCTA != null) {
			...
			document.getElementsByName("cta_code")[0].value = getUrlVar("PC");
				...
				if (pageURL.includes("/solutions/healthcare/")){
					document.getElementsByName("cta_code")[0].value = "WEB-GET-BR-HC";
					document.getElementsByName("tactic_code")[0].value = "WEB-GET-BR-HC";
					document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-BR-HC";
				} else if (pageURL.includes("/solutions/hospitality/")){
					document.getElementsByName("cta_code")[0].value = "WEB-GET-BR-HOSP";
					document.getElementsByName("tactic_code")[0].value = "WEB-GET-BR-HOSP";
					document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-BR-HOSP";
				} else if (pageURL.includes("/solutions/government-and-public-safety/")){
					document.getElementsByName("cta_code")[0].value = "WEB-GET-BR-GOV";
					document.getElementsByName("tactic_code")[0].value = "WEB-GET-BR-GOV";
					document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-BR-GOV";
				} else if (pageURL.includes("/solutions/education/")){
					document.getElementsByName("cta_code")[0].value = "WEB-GET-BR-EDU";
					document.getElementsByName("tactic_code")[0].value = "WEB-GET-BR-EDU";
					document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-BR-EDU";
				} else if (pageURL.includes("/solutions/financial-services/")){
					document.getElementsByName("cta_code")[0].value = "WEB-GET-BR-FIN";
					document.getElementsByName("tactic_code")[0].value = "WEB-GET-BR-FIN";
					document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-BR-FIN";
				} else if (pageURL.includes("/solutions/sports-and-entertainment/")){
					document.getElementsByName("cta_code")[0].value = "WEB-GET-BR-ENT";
					document.getElementsByName("tactic_code")[0].value = "WEB-GET-BR-ENT";
					document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-BR-ENT";
				} else {
					document.getElementsByName("cta_code")[0].value = "WEB-GET-BR-HC";
					document.getElementsByName("tactic_code")[0].value = "WEB-GET-BR-HC";
					document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-ES-HC";
				}
			}
		if (SessTAC != null) {
			console.log(SessTAC);
...
subonclick= document.getElementById("fe87087");
