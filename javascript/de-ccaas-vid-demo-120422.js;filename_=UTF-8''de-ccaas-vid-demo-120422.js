...
/*if (!!getCookie('FName')){
	...
	labelatt('fe121459');//hide EmailOptin label
	document.getElementById("fe121459").type = "hidden";
} else {
...
if (!!getCookie('LName')){
	...
	labelatt('fe121460');//hide EmailOptin label
	document.getElementById("fe121460").type = "hidden";
} else {
...
if (!!getCookie('country')){
	...
	labelatt('fe121464');//hide EmailOptin label
	document.getElementById("fe121464").type = "hidden";
} else {
...
labelatt('fe121466');//hide EmailOptin label
document.getElementById("fe121466").type = "hidden"; //EmailOptin is text field to hide this field
...
divGDPRtext.innerHTML = "<div style='color: #000;width: 90%;margin-left: 25px;margin-bottom: 30px;margin-top: 15px;font-size:13px;line-height:20px;'>Mit dem Absenden willige ich in die Verarbeitung meiner angegebenen Daten zum Zweck der angegeben Aktion ein. Weitere Informationen finden Sie in unserer <a href='https://www.avaya.com/de/privacy/website/' target='_blank' style='color:#000000;text-decoration:underline;font-size: 13px;border-bottom: 0px solid;'>Datenschutzerklärung</a>. Sie können Sie Ihre E-Mail-Einstellungen <a href='https://news.avaya.com/global-subscription' target='_blank' style='color:#000000;text-decoration:underline;font-size: 13px;border-bottom: 0px solid;'>hier</a> verwalten.</div>";
...
fe121459.add(Validate.Presence, {failureMessage:"Mussfeld"});
fe121460.add(Validate.Presence, {failureMessage:"Mussfeld"});
fe121461.add(Validate.Presence, {failureMessage:"Mussfeld"});
fe121461.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "Es wird eine gültige E-Mail Adresse benötigt"});
fe121464.add(Validate.Presence, {failureMessage:"Mussfeld"});
...
//GA Script
document.getElementById('form3841').addEventListener(
