...
//document.getElementById("formElement7").style.display = "none";
//document.getElementById("formElement7").style.display = "none";
//document.getElementById("formElement9").style.display = "none";
document.getElementById("formElement9").style.display = "none";//State
document.getElementById("formElement11").style.display = "none";
document.getElementById("formElement14").style.display = "none";//not to display address 3 field container
...
document.getElementById("formElement12").style.marginBottom = "15px";
document.getElementById("formElement13").style.marginBottom = "15px";
...
/*** GDPR Optin / Optout Code **************/
			...
			/*function checkOptin(){
				...
				if(checkbox1.checked == true){
					...
					document.getElementsByName("emailOptinSource1")[0].value = "20AVAYA-CLOUD-AGENT";
...
labelatt('fe90775');//hide EmailOptin label
...
document.getElementById("fe90775").type = "hidden";//EmailOptin is text field to hide this field
...
divGDPRtext.innerHTML = "<div style='color: #000;width: 90%;margin-left: 25px;margin-bottom: 30px;margin-top: 15px;font-size:13px;line-height:20px;'>By submitting this form, I agree to my information being processed in the Avaya database.<br> See our <a href='https://www.avaya.com/en/privacy/website/' target='_blank' style='color:#DA291C;text-decoration:underline;'>Privacy Statement</a> for more details, or manage your <a href='https://news.avaya.com/partner-preference-center' target='_blank' style='color:#DA291C;text-decoration:underline;'>Email Preferences</a> at any time.</div>";
...
document.getElementById('formElement15').style.marginTop = "20px";
var container=document.getElementById('formElement15');
...
//document.getElementById("lineb1").style.lineHeight = "15px";
...
ContactText.id="ContactDetails";
ContactText.innerHTML = "<div style='color: #000;width: 90%;margin-left: 25px;margin-bottom: 5px;margin-top: 5px;font-size:13px;line-height:20px;'>For additional questions contact: <a href='mailto:acoinfo@avaya.com'  style='color:#DA291C;text-decoration:underline;'>acoinfo@avaya.com</a></div>";
document.getElementById('formElement16').style.marginTop = "20px";
var containerCT=document.getElementById('formElement16');
containerCT.appendChild(ContactText);
 ContactText.setAttribute("style","float: center;clear: both;min-width: 400px;display: inline;margin:auto 20px auto 20px;line-height:30px; font-size:25px;");
console.log("Check2");

var masteragent = document.getElementsByName('Affiliated-Master-Agent')[0];
var YourRole1 = document.getElementsByName('YourRole')[0];
removeOptions(masteragent);//call remove function to remove dropdown options
removeOptions(YourRole1);

var listMA = ['Please select','Yes','No'];
var listMAO = ['','Yes','No'];
var listRole = ['Please select','Admin/Owner','Sales'];
var listRoleO = ['','Admin/Owner','Sales'];
createOption(masteragent, "Please select", "");
createOption(YourRole1, "Please select", "");

for (i = 1; i < listMA.length; i++) {
		createOption(masteragent, listMA[i], listMAO[i]);
} 
for (i = 1; i < listRole.length; i++) {
		createOption(YourRole1, listRole[i], listRoleO[i]);
} 


console.log("Check3");

masteragent = document.getElementsByName("Affiliated-Master-Agent")[0];

masteragent.addEventListener('change', showDetails);

console.log(document.getElementsByName("Affiliated-Master-Agent")[0].value);
function showDetails(){

	if (document.getElementsByName("Affiliated-Master-Agent")[0].value == "Yes"){

	document.getElementById("formElement11").style.display = "block";
	var fe92326 = new LiveValidation( "fe92326", { validMessage: "", onlyOnBlur: true });
		fe92326.enable();
		fe92326.add( Validate.Presence, { failureMessage: "This field is required" } );	
...
function detect_ccode(){
		var strUser=document.getElementsByName("country")[0].value;
				...
				if(strUser=="United States")
				{
					$("#formElement9").slideDown();
					var fe92849 = new LiveValidation("fe92849", {validMessage: "", onlyOnBlur: true});
					fe92849.enable();
					fe92849.add(Validate.Presence, {failureMessage:"This field is required"});
				}
				else
				{
					$("#formElement9").slideUp();
					var fe92849 = new LiveValidation('fe92849');
					fe92849.disable();
				}
...
document.getElementsByName("contentTitle1")[0].value = "Become an Avaya Cloud Agent";//Insert content title here
...
//for Validation
fe90757.add(Validate.Presence, {failureMessage:"This field is required"});
fe90758.add(Validate.Presence, {failureMessage:"This field is required"});
fe90759.add(Validate.Presence, {failureMessage:"This field is required"});
fe90759.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "A valid email address is required"});
fe90760.add(Validate.Presence, {failureMessage:"This field is required"});
fe90761.add(Validate.Presence, {failureMessage:"This field is required"});
fe90762.add(Validate.Presence, {failureMessage:"This field is required"});
fe92325.add(Validate.Presence, {failureMessage:"This field is required"});
fe92327.add(Validate.Presence, {failureMessage:"This field is required"});

fe92847.add(Validate.Presence, {failureMessage:"This field is required"});
fe92848.add(Validate.Presence, {failureMessage:"This field is required"});
fe94316.add(Validate.Presence, {failureMessage:"This field is required"});

subonclick= document.getElementById("fe90783");
...
/*GA*/
 ...
 document.getElementById('form3195').addEventListener(
