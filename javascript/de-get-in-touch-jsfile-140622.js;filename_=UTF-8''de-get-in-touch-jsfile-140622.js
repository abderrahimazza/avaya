...
/*** GDPR Optin / Optout Code **************/
			...
			function checkOptin(){
				...
				if(checkbox1.checked == true){
					...
					document.getElementsByName("emailOptinSource1")[0].value = "WEB-GET-DE";
...
labelatt('fe85658');//hide EmailOptin label
...
document.getElementById("fe85658").type = "hidden"; //EmailOptin is text field to hide this field
...
divGDPRtext.innerHTML = "<div style='color: #313133;width: 95%;margin-left: 5px;margin-bottom: 30px;margin-top: 15px;font-size:12px;line-height:20px;'>Mit dem Absenden willige ich in die Verarbeitung meiner angegebenen Daten zum Zweck der angegeben Aktion ein. Weitere Informationen finden Sie in unserer <a href='https://www.avaya.com/de/privacy/website/' target='_blank' style='text-decoration:underline;font-size:12px;line-height:20px;border-bottom: 0px solid;color:#1B77AF;' class='formStatLink'>Datenschutzerklärung</a>. Sie können Sie Ihre E-Mail-Einstellungen <a href='https://news.avaya.com/global-subscription' target='_blank' style='text-decoration:underline;font-size:12px;line-height:20px;border-bottom: 0px solid;color:#1B77AF;' class='formStatLink'>hier</a> verwalten.</div>";
...
if(ref == ""){
  ...
  document.getElementsByName("contentURL1")[0].value = pageLoc;  //passing pageLoc value to the content URL fiel
} 
else{
...
var SessTAC = getCookie('tac');
		if (SessCTA != null) {
			...
			document.getElementsByName("cta_code")[0].value = "WEB-GET-DE";
		}
		if (SessTAC != null) {
			console.log(SessTAC);
			...
			document.getElementsByName("tactic_code")[0].value = "WEB-GET-DE";
		}*/
...
//for Validation
fe85630.add(Validate.Presence, {failureMessage:"Mussfeld"});
fe85631.add(Validate.Presence, {failureMessage:"Mussfeld"});
fe85632.add(Validate.Presence, {failureMessage:"Mussfeld"});
fe85632.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "Es wird eine gültige E-Mail Adresse benötigt"});
fe85633.add(Validate.Presence, {failureMessage:"Mussfeld"});
fe85634.add(Validate.Presence, {failureMessage:"Mussfeld"});
fe85635.add(Validate.Presence, {failureMessage:"Mussfeld"});
fe85636.add(Validate.Presence, {failureMessage:"Mussfeld"});
fe85637.add(Validate.Presence, {failureMessage:"Mussfeld"});
fe85638.add(Validate.Presence, {failureMessage:"Mussfeld"});

subonclick= document.getElementById("fe85668");
...
/*GA*/
 ...
 document.getElementById('form3021').addEventListener(
