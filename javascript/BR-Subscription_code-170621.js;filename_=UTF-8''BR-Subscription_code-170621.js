...
/*** GDPR Optin / Optout Code **************/
			...
			function checkOptin(){
				...
				if(checkbox1.checked == true){
					...
					document.getElementsByName("emailOptinSource1")[0].value = "9USA-SUB-DG-LP-CME-PO";
...
labelatt('fe94209');//hide EmailOptin label
...
document.getElementById("fe94209").type = "hidden";//EmailOptin is text field to hide this field
...
divGDPRtext.innerHTML = "<div style='color: #000;width: 90%;margin-left: 25px;margin-bottom: 30px;margin-top: 15px;font-size:13px;line-height:20px;'>Ao submeter este formulário, estou de acordo que os meus dados sejam processados na base de dados da Avaya para o fim acima mencionado. Consulte a nossa <a href='https://www.avaya.com/br/privacy/website/' target='_blank' style='color:#DA291C;text-decoration:underline;'>Declaração de Privacidade</a> para mais detalhes, ou configure em qualquer momento as suas <a href='https://news.avaya.com/global-subscription' target='_blank' style='color:#DA291C;text-decoration:underline;'>preferências de email</a>.</div>";
...
document.getElementsByName("contentTitle1")[0].value = "Saiba mais sobre Avaya IX Subscription";//Insert content title here
...
//for Validation
fe94191.add(Validate.Presence, {failureMessage:"Campo obrigatório"});
fe94192.add(Validate.Presence, {failureMessage:"Campo obrigatório"});
fe94193.add(Validate.Presence, {failureMessage:"Campo obrigatório"});
fe94193.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "Endereço de e-mail válido"});
fe94194.add(Validate.Presence, {failureMessage:"Campo obrigatório"});
fe94195.add(Validate.Presence, {failureMessage:"Campo obrigatório"});
fe94196.add(Validate.Presence, {failureMessage:"Campo obrigatório"});
...
/*GA*/
 ...
 document.getElementById('form3290').addEventListener(
