...
/*** GDPR Optin / Optout Code **************/
			...
			function checkOptin(){
				...
				if(checkbox1.checked == true){
					...
					document.getElementsByName("emailOptinSource1")[0].value = "RU-OWCS-contact-us";
...
labelatt('fe117765');//hide EmailOptin label
...
document.getElementById("fe117765").type = "hidden"; //EmailOptin is text field to hide this field
...
divGDPRtext.innerHTML = "<div style='color: #000;width: 90%;margin-left: 25px;margin-bottom: 30px;margin-top: 15px;font-size:13px;line-height:20px;'>Заполняя данную форму, я даю свое согласие Avaya на обработку моих персональных данных в соответствии с вышеуказанным запросом. Вы можете ознакомиться с <a href='https://www.avaya.com/ru/privacy/commitment/' target='_blank' style='color:#DA291C;text-decoration:underline;font-size: 13px;border-bottom: 0px solid;'>Положением о конфиденциальности</a> или изменить <a href='https://news.avaya.com/global-subscription' target='_blank' style='color:#DA291C;text-decoration:underline;font-size: 13px;border-bottom: 0px solid;'>Условия новостной рассылки</a> в любое время.</div>";
...
document.getElementsByName("contentTitle1")[0].value = "Узнайте больше о решениях для удаленной работы";//Insert content title here
...
//for Validation
fe117740.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
fe117741.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
fe117742.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
fe117742.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "Требуется действительный адрес электронной почты"});
fe117743.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
fe117744.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
fe117747.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
...
} else if (pageURL.includes("/solutions/work-from-anywhere/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-RU";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-RU-WFA";
		document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-RU";
		document.getElementsByName("contentTitle1")[0].value = "Узнайте больше о решениях для удаленной работы";//Insert content title here
...
subonclick= document.getElementById("fe117796");
