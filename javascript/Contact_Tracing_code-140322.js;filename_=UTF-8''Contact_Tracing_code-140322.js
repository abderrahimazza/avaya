...
/*** GDPR Optin / Optout Code **************/
			...
			function checkOptin(){
				...
				if(checkbox1.checked == true){
					...
					document.getElementsByName("emailOptinSource1")[0].value = "20US-CC-DG-CTTRC";
...
labelatt('fe98552');//hide EmailOptin label
...
document.getElementById("fe98552").type = "hidden"; //EmailOptin is text field to hide this field
...
checkbox.value = "";
checkbox.id = "optin";
//checkbox.arialabel = "Yes, I also agree to receive marketing emails from Avaya.";
...
document.getElementsByName("contentTitle1")[0].value = "Contact Tracing - Contact Us";//Insert content title here
...
//for Validation
fe98500.add(Validate.Presence, {failureMessage:"This field is required"});
fe98502.add(Validate.Presence, {failureMessage:"This field is required"});
fe98503.add(Validate.Presence, {failureMessage:"This field is required"});
fe98503.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "A valid email address is required"});
fe98504.add(Validate.Presence, {failureMessage:"This field is required"});
fe98507.add(Validate.Presence, {failureMessage:"This field is required"});
fe98514.add(Validate.Presence, {failureMessage:"This field is required"});
...
subonclick= document.getElementById("fe98559");
...
/*GA*/
 ...
 document.getElementById('form3405').addEventListener(
