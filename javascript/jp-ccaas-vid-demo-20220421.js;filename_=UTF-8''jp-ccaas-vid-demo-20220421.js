...
/*if (!!getCookie('FName')){
	...
	labelatt('fe121703');//hide EmailOptin label
	document.getElementById("fe121703").type = "hidden";
} else {
...
if (!!getCookie('LName')){
	...
	labelatt('fe121704');//hide EmailOptin label
	document.getElementById("fe121704").type = "hidden";
} else {
...
if (!!getCookie('country')){
	...
	labelatt('fe121708');//hide EmailOptin label
	document.getElementById("fe121708").type = "hidden";
} else {
...
labelatt('fe121710');//hide EmailOptin label
document.getElementById("fe121710").type = "hidden"; //EmailOptin is text field to hide this field
...
divGDPRtext.innerHTML = "<div style='color: #000;width: 90%;margin-left: 25px;margin-bottom: 30px;margin-top: 15px;font-size:13px;line-height:20px;font-family: HCo Gotham SSm;'>このフォームを送ることでご自分の個人情報をアバイアのデーターベースにて上記の目的で 使用されることにご同意いただいたことになります。アバイアのプライバシーステイトメントは<a href='https://www.avaya.com/jp/privacy/website/' target='_blank' style='color:#DA291C;text-decoration:underline;font-size: 13px;border-bottom: 0px solid;'>こちら</a>でご確認いただけます。受信解除やメールの設定は<a href='https://news.avaya.com/global-subscription' target='_blank' style='color:#DA291C;text-decoration:underline;font-size: 13px;border-bottom: 0px solid;'>こちら</a>からいつでも変更可能です。</div>";
...
fe121703.add(Validate.Presence, {failureMessage:"会社名をご記入ください."});
fe121704.add(Validate.Presence, {failureMessage:"会社名をご記入ください."});
fe121705.add(Validate.Presence, {failureMessage:"会社名をご記入ください."});
fe121705.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "メールアドレスをご記入ください."});
fe121708.add(Validate.Presence, {failureMessage:"会社名をご記入ください."});
...
//GA Script
document.getElementById('form3845').addEventListener(
