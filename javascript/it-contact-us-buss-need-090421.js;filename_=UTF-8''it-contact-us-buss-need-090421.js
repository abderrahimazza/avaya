...
if (SessCTA != null) {
    ...
    if (pageURL.includes("/solutions/customer-experience-and-contact-center/")){
        document.getElementsByName("cta_code")[0].value = "WEB-GET-IT-CE";
        document.getElementsByName("tactic_code")[0].value = "WEB-GET-IT-CE";
        document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-IT-CE";
        document.getElementsByName("contentTitle1")[0].value = "Inizia a trasformare la tua esperienza cliente";//Insert content title here
        ...
        document.getElementsByName("cta_code")[0].value = "WEB-GET-IT-TEAM";
        document.getElementsByName("tactic_code")[0].value = "WEB-GET-IT-TEAM";
        document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-IT-TEAM";
        document.getElementsByName("contentTitle1")[0].value = "Migliora la tua produttività già a partire da oggi";//Insert content title here
        document.getElementsByName('area_of_interest')[0].value = "UC";
    } else if (pageURL.includes("/solutions/digital-transformation/")){
        document.getElementsByName("cta_code")[0].value = "WEB-GET-IT-DX";
        document.getElementsByName("tactic_code")[0].value = "WEB-GET-IT-DX";
        document.getElementsByName("contact_source_detailed")[0].value = "WEB-GET-IT-DX";
        document.getElementsByName("contentTitle1")[0].value = "Inizia il cambiamento";//Insert content title here
        document.getElementsByName('area_of_interest')[0].value = "UC";
    }
}
