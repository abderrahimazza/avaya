...
/*** GDPR Optin / Optout Code **************/
			...
			function checkOptin(){
				...
				if(checkbox1.checked == true){
					...
					document.getElementsByName("emailOptinSource1")[0].value = "Global-OWCS-contact-us";
...
labelatt('fe86136');//hide EmailOptin label
...
document.getElementById("fe86136").type = "hidden"; //EmailOptin is text field to hide this field
...
divGDPRtext.innerHTML = "<div style='color: #000;width: 90%;margin-left: 25px;margin-bottom: 30px;margin-top: 15px;font-size:13px;line-height:20px;'>By submitting this form, I agree to my information being processed in the Avaya database for the above mentioned purpose. See our <a href='https://www.avaya.com/en/privacy/website/' target='_blank' style='text-decoration:underline;font-size: 13px;border-bottom: 0px solid;'>Privacy Statement</a> for more details, or manage your <a href='https://news.avaya.com/global-subscription' target='_blank' style='text-decoration:underline;font-size: 13px;border-bottom: 0px solid;'>Email Preferences</a> at any time.</div>";
...
/*
document.getElementById("form3038").setAttribute("aria-label", "Please complete the form to request that an Avaya solutions specialist contact you.");
...
document.getElementsByName("company_name")[0].setAttribute("aria-label", "Company");
document.getElementsByName("country")[0].setAttribute("aria-label", "Country/Region");
document.getElementsByName("contactComments")[0].setAttribute("aria-label", "Message");*/
...
//for Validation
fe86111.add(Validate.Presence, {failureMessage:"This field is required"});
fe86112.add(Validate.Presence, {failureMessage:"This field is required"});
fe86113.add(Validate.Presence, {failureMessage:"This field is required"});
fe86113.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "A valid email address is required"});
fe86114.add(Validate.Presence, {failureMessage:"This field is required"});
fe86115.add(Validate.Presence, {failureMessage:"This field is required"});
fe86118.add(Validate.Presence, {failureMessage:"This field is required"});
...
if (getUrlVar("CTA") != ""){
	...
	if (pageURL.includes("/solutions/healthcare/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-EN-HC";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-EN-HC";
	} else if (pageURL.includes("/solutions/hospitality/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-EN-HOSP";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-EN-HOSP";
	} else if (pageURL.includes("/solutions/government/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-EN-GOV";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-EN-GOV";
	} else if (pageURL.includes("/solutions/public-safety/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-EN-GOV";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-EN-GOV";
	} else if (pageURL.includes("/solutions/education/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-EN-EDU";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-EN-EDU";
	} else if (pageURL.includes("/solutions/financial-services/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-EN-FIN";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-EN-FIN";
	} else if (pageURL.includes("/solutions/sports-and-entertainment/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-EN-ENT";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-EN-ENT";
	} else {
		document.getElementsByName("cta_code")[0].value = "WEB-GET-EN";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-EN";
	}
}
/*if (SessTAC != null) {
	console.log(SessTAC);
...
subonclick= document.getElementById("fe86142");
...
/*GA*/
 ...
 document.getElementById('form3038').addEventListener(
