...
if (document.getElementById('formElement8')){
	...
	if (document.getElementById('fe107200')){
		var div81a = document.getElementById('fe107200');
		var div81b = div81a.getElementsByTagName('div');
		console.log("div81b  === "+div81b.length);
		div81b[0].setAttribute("style", "width: 80px !important; display: table-cell;vertical-align: top;");
		div81b[1].setAttribute("style", "width: 80px !important; display: table-cell;vertical-align: top;");
...
if (document.getElementById('formElement7')){
	...
	if (document.getElementById('fe107199')){
		var div71a = document.getElementById('fe107199');
		var div71b = div71a.getElementsByTagName('div');
		console.log("div71b  === "+div71b.length);
		div71b[0].setAttribute("style", "width: 80px !important;height:42px;display: table-cell;vertical-align: top; padding-top:10px;");
		div71b[1].setAttribute("style", "width: 80px !important;height:42px;display: table-cell;vertical-align: top; padding-top:10px;");
...
if (document.getElementById('formElement7')){
	document.getElementById('formElementid7').style['float'] = "left";
	var fielsetTitle = "";
	var labeldy= "";
	var ELe3 = "";
	var checkboxfields = "";
	var VarEle = document.getElementById("formElement7").innerHTML;
	...
	var checkboxfields = document.getElementById("fe107199").innerHTML;
	document.getElementById("formElement7").innerHTML = "";
	var checkbox = "<fieldset><legend style='padding-bottom:10px'>"+fielsetTitle+"</legend>";
	checkbox = checkbox+checkboxfields+"</fieldset>";
	document.getElementById("formElement7").innerHTML = checkbox;
}
if (document.getElementById('formElement8')){
	var div8 = document.getElementById('formElement8');
	div8.setAttribute("style", "padding-bottom:15px;float:left;");
	//document.getElementById('formElementid8').style['float'] = "left";
	var div81 = div8.getElementsByTagName('div')[1];
	div81.setAttribute("style", "display: table;");
	var div811 = div81.childNodes;
	console.log("div811.length == "+div811.length);
	...
	var ELe31 = "";
	var checkboxfields1 = "";
	var VarEle1 = document.getElementById("formElement8").innerHTML;
	console.log("VarEle1 = "+VarEle1);
	var labels1 = document.getElementsByTagName('label');
	for(var i = 0; i < labels1.length; i ++) {
        var attr1 = labels1[i].getAttribute('for'); //or labels[i].htmlFor
        if(attr1 === "fe107200") {
			var checkboxcc = labels1[i].parentElement;
			console.log(checkboxcc.innerHTML);
           // labels[i].style.visibility = 'hidden';
           fielsetTitle1 = labels1[i].innerHTML;
		   console.log(fielsetTitle1);
        }
	}
	var checkboxfields1 = document.getElementById("fe107200").innerHTML;
	document.getElementById("formElement8").innerHTML = "";
	var checkbox1 = "<fieldset><legend style='padding-bottom:10px'>"+fielsetTitle1+"</legend>";
	checkbox1 = checkbox1+checkboxfields1+"</fieldset>";
	document.getElementById("formElement8").innerHTML = checkbox1;
}
			...
			function checkOptin(){
				...
				if(checkbox1.checked == true){
					...
					document.getElementsByName("emailOptinSource1")[0].value = "WEB-GET-FR-SMB-CC";
...
vUsingCCSolutionYes.addEventListener("change", usingSolutionYes, false);
vUsingCCSolutionNo.addEventListener("change", usingSolutionNo, false);
//vCurrentAvayaCustomerYes.addEventListener("change", usingSolutionYes, false);
//vCurrentAvayaCustomerNo.addEventListener("change", usingSolutionNo, false);
function usingSolutionYes(){
	console.log("vUsingCCSolutionYes");
	document.getElementById('formElement9').style.display = "block";
	var fe107201 = new LiveValidation( "fe107201", { validMessage: "", onlyOnBlur: true });
		fe107201.enable();
		fe107201.add( Validate.Presence, { failureMessage: "Champ obligatoire" } );	
	document.getElementsByName('UsingCCSolution')[0].focus();
}
function usingSolutionNo(){
	console.log("vUsingCCSolutionNo");
...
document.getElementById("fe107219").type = "hidden"; //EmailOptin is text field to hide this field
...
pInstruct.innerHTML = "<font style='color: #313133;font-weight: 500;font-size:12px'>Tous les champs marqués d'un <span style='color: #da291c; font-size: 12px;'>*</span> sont obligatoires.</font>";
...
label.innerHTML = "Oui, j'accepte également de recevoir des courriers électroniques marketing d'Avaya.";
var divGDPRtext = document.createElement("div");
divGDPRtext.id="gdprtext";
divGDPRtext.innerHTML = "<div style='color: #313133;width: 95%;margin-left: 5px;margin-bottom: 30px;margin-top: 15px;font-size:12px;line-height:20px;' class='formStatement'>En soumettant ce formulaire, j'accepte que mes informations soient traitées dans la base de données Avaya, dans le but mentionné ci-dessus. Consultez notre <a href='https://www.avaya.com/fr/privacy/website/' class='formStatLink' target='_blank' style='text-decoration:underline;font-size: 12px;border-bottom: 0px solid;color:#1B77AF;'>déclaration de confidentialité</a> pour plus de détails ou gérez vos <a href='https://news.avaya.com/global-subscription' class='formStatLink' target='_blank' style='text-decoration:underline;font-size: 12px;border-bottom: 0px solid;color: #1B77AF;'>préférences de courrier électronique</a> quand vous le souhaitez.</div>";
...
document.getElementById("optin").setAttribute("aria-label", "Oui, j'accepte également de recevoir des courriers électroniques marketing d'Avaya.");
...
document.getElementsByName("first_name")[0].setAttribute("aria-label", "Prénom");
document.getElementsByName("last_name")[0].setAttribute("aria-label", "Nom de famille");
document.getElementsByName("email")[0].setAttribute("aria-label", "E-mail");
document.getElementsByName("phone")[0].setAttribute("aria-label", "Numéro de téléphone");
document.getElementsByName("company_name")[0].setAttribute("aria-label", "Nom de la société");
document.getElementsByName("AgentsNeeded")[0].setAttribute("aria-label", "Nombre d'agents requis");
document.getElementsByName("country")[0].setAttribute("aria-label", "Pays");
document.getElementsByName("AreYouCurrentAvayaCustomer")[0].setAttribute("aria-label", "Oui");
document.getElementsByName("AreYouCurrentAvayaCustomer")[1].setAttribute("aria-label", "Non");
document.getElementsByName("UsingCCSolution")[0].setAttribute("aria-label", "Oui");
document.getElementsByName("UsingCCSolution")[1].setAttribute("aria-label", "Non");
document.getElementsByName("comments")[0].setAttribute("aria-label", "Message");
...
document.getElementsByName("content_title")[0].value = "Contactez le service commercial";//passing value for content title
...
fe107192.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe107193.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe107194.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe107194.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "Une adresse e-mail valide est requise"});
fe107195.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe107196.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe107197.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
fe107198.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
//fe107199.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
//fe107200.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
var dom8 = document.querySelectorAll('[name="AreYouCurrentAvayaCustomer"]');
var fe107199 = new LiveValidation(dom8, {validMessage: "", onlyOnBlur: false, wait: 300, insertAfterWhatNode :this.getParentElement(dom8), isGroup: true}, true);
fe107199.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
var dom9 = document.querySelectorAll('[name="UsingCCSolution"]');
var fe107200 = new LiveValidation(dom9, {validMessage: "", onlyOnBlur: false, wait: 300, insertAfterWhatNode :this.getParentElement(dom9), isGroup: true}, true);
fe107200.add(Validate.Presence, {failureMessage:"Champ obligatoire"});
...
var div14a = document.getElementById('fe107229');
...
function OnLoadCreateFields(){
	...
	AreYouCurrentAvayaCustomerValid.add( Validate.Presence, { failureMessage: "Champ obligatoire" } );
	...
	UsingCCSolutionValid.add( Validate.Presence, { failureMessage: "Champ obligatoire" } );
...
if (getUrlVar("CTA") != ""){
	...
	if (pageURL.includes("/produits/ccaas/public/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-EN-SMB-CC";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-EN-SMB-CC-FR";
	}else if (pageURL.includes("/ccaas/public-pricing/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-EN-SMB-CC";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-EN-SMB-CC-PRC-FR";
	} else if (pageURL.includes("/ccaas/public-features/")){
		document.getElementsByName("cta_code")[0].value = "WEB-GET-EN-SMB-CC";
		document.getElementsByName("tactic_code")[0].value = "WEB-GET-EN-SMB-CC-FEA-FR";
	} 
}
if (getUrlVar("TAC") != ""){
...
css = css+ '.av-mod-col #formElementid7{float:right !important}';
css = css+ '.av-mod-col #formElementid8{float:left !important}';
css = css+ '.row  legend{font-family: "Noto Sans JP";font-size: 12px;line-height: 20px !important;color: #313133;font-weight: bold;}';
css = css+ '.grid-layout-col .two-column input {float: left;margin-top: 2px;}';
css = css+ '#formElementid9{float:right !important;}';
css = css+ '.row .grid-layout-col fieldset{background-color: #ffffff !important;}';

css = css+ '.av-form-columns .elq-form .LV_validation_message{margin:0px !important}';
...
/*GA*/
 ...
 document.getElementById('form3599').addEventListener(
...
document.getElementById("fe107229").setAttribute("aria-label", "Envoyer"); 
