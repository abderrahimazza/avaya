...
/*** GDPR Optin / Optout Code **************/
			...
			function checkOptin(){
				...
				if(checkbox1.checked == true){
					...
					document.getElementsByName("emailOptinSource1")[0].value = "9USA-SUB-DG-LP-CME-SP";
...
labelatt('fe89787');//hide EmailOptin label
...
document.getElementById("fe89787").type = "hidden";//EmailOptin is text field to hide this field
...
divGDPRtext.innerHTML = "<div style='color: #000;width: 90%;margin-left: 25px;margin-bottom: 30px;margin-top: 15px;font-size:13px;line-height:20px;'>Al enviar este formulario, acepto que mi información se procese en la base de datos de Avaya para el propósito mencionado anteriormente. Consulta nuestra <a href='https://www.avaya.com/es/privacy/website/' target='_blank' style='color:#DA291C;text-decoration:underline;'>Declaración de privacidad</a> para obtener más detalles o Administra tus <a href='https://news.avaya.com/global-subscription' target='_blank' style='color:#DA291C;text-decoration:underline;'>preferencias de correo electrónico</a> en cualquier momento.</div>";
...
document.getElementsByName("contentTitle1")[0].value = "Obtenga más Información sobre la Suscripción Avaya IX";//Insert content title here
...
//for Validation
fe89769.add(Validate.Presence, {failureMessage:"Este campo es requerido"});
fe89770.add(Validate.Presence, {failureMessage:"Este campo es requerido"});
fe89771.add(Validate.Presence, {failureMessage:"Este campo es requerido"});
fe89771.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "Dirección de correo electrónico válida"});
fe89772.add(Validate.Presence, {failureMessage:"Este campo es requerido"});
fe89773.add(Validate.Presence, {failureMessage:"Este campo es requerido"});
fe89774.add(Validate.Presence, {failureMessage:"Este campo es requerido"});
...
/*GA*/
 ...
 document.getElementById('form3166').addEventListener(
