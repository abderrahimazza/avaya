...
document.getElementById("formElement17").style.display = "none";//on load hide Avaya Representative Name field
...
createOption(partnertype, "Пожалуйста, выберите из списка", "");
...
function populateReferredBy(){
	...
	if (document.getElementsByName('PartnerType')[0].value == "Avaya Authorized Reseller"){
		...
		var RegRB = ['Пожалуйста, выберите из списка','Дистрибьютор Avaya','Представитель Avaya','None'];// creating array with all the options to populate dropdown option label in case of Partner Type = Avaya Authorized Reseller
		var RegRBO = ['','Avaya Distributor','Avaya Representative','None'];// creating array with all the options to populate dropdown value for all the options in case of Partner Type = Avaya Authorized Reseller
	} else if (document.getElementsByName('PartnerType')[0].value == "Avaya Registered Reseller"){
		console.log("2 option");
		var RegRB = ['Пожалуйста, выберите из списка','Авторизованный партнёр Avaya','None'];// creating array with all the options to populate dropdown option label in case of Partner Type = Avaya Registered Reseller
		...
		var RegRB = ['Пожалуйста, выберите из списка','Дистрибьютор Avaya','None'];// creating array with all the options to populate dropdown option label in case of Partner Type = Avaya Open Product Reseller
		...
		var RegRB = ['Пожалуйста, выберите из списка','Дистрибьютор Avaya'];// creating array with all the options to populate dropdown option label in case of Partner Type = Avaya Distributor
		...
		var RegRB = ['Пожалуйста, выберите из списка','Дистрибьютор Avaya','Представитель Avaya','Авторизованный партнёр Avaya','None'];// creating array with all the options to populate dropdown option label in case of Partner Type = Avaya Sales Agent
		var RegRBO = ['','Avaya Distributor','Avaya Representative','Avaya Authorized Reseller','None'];// creating array with all the options to populate dropdown value for all the options in case of Partner Type = Avaya Sales Agent
	} else {
		var RegRB = ['Пожалуйста, выберите из списка'];// creating array with all the options to populate dropdown option label in case of Partner Type = Avaya Sales Agent
		var RegRBO = [''];// creating array with all the options to populate dropdown value for all the options in case of Partner Type = Avaya Sales Agent
	}
	vrefferedby.options.length = 0;
	createOption(vrefferedby, "Пожалуйста, выберите из списка", "");
...
refferedby.onchange = function() {
	if (document.getElementsByName('ReferredBy')[0].value == "Avaya Distributor"){
		...
		//if (document.getElementsByName("Theater")[0].value == "EMEA" || document.getElementsByName("Theater")[0].value == "APAC"){
			...
			if (document.getElementsByName("country")[0].value=="Afghanistan"){
				var DistiList1 = ['Пожалуйста, выберите из списка','Almasa IT Distribution FZCO','WESTCON MIDDLE EAST LIMITED'];
				...
				var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','Ingram Micro Sp. z. o. o.','BD ENTERPRISE NETWORKING LTD.','Ingram Micro doo','Westcon Convergence UK'];
				...
				var DistiList1 = ['Пожалуйста, выберите из списка','First Video Communications FZ LLC','ITANCIA (WAS NETACOM)','REDINGTON GULF','WESTCON MIDDLE EAST LIMITED','ITANCIA Africa','International Distributors (Interdist) offshore SAL','Westcon Africa Morocco'];
				...
				var DistiList1 = ['Пожалуйста, выберите из списка','First Video Communications FZ LLC','REDINGTON GULF','Westcon Africa FZCo, UNITED KINGDOM','International Distributors (Interdist) offshore SAL','Epsidon Technology (Pty) Ltd'];
				...
				var DistiList1 = ['Пожалуйста, выберите из списка','ANIXTER, INC (CALA)','AVT Inc., Caribbean & Cen America','NetPoint International','DACAS Corp','Electrica A-B SA de CV'];
				...
				var DistiList1 = ['Пожалуйста, выберите из списка','AVAYA A1S DEMO  Antartic Distributor 1','AVAYA A1S DEMO Antartic Distributor 2tributor 2'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ANIXTER, INC (CALA)','Anixter Argentina S.A.','AVT Inc., Caribbean & Cen America','Avnet Inc., Southern Cone Region','Redes y Distribucion S.A.','Dacas SA'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','MARVEL COMPUTER SOLUTIONS LTD','BD ENTERPRISE NETWORKING LTD.','RRC RUSSIA'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Arrow ECS Australia Pty Limited (formerly known as Distribution Central Pty Limited)','CommPlus Australia','Westcon Group Pty Limited','VoIP Distribution Pty Ltd trading as VExpress'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','ScanSource Communications GmbH Germany','AVAD GMBH','Westcon Convergence UK','ScanSource UK','Westcon Convergence Germany','Scansource Europe S.P.R.L.','ScanSource Communications Austria','Westcon Group Austria'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','MARVEL COMPUTER SOLUTIONS LTD','NETEKS ILETISIM URUNLERI DAGITIM ANONIM SIRKETI','BD ENTERPRISE NETWORKING LTD.','RRC RUSSIA'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Redington India Limited','Brightstar Telecommunications India Limited'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ANIXTER, INC (CALA)','AVT Inc., Caribbean & Cen America','Anixter Caribbean Region','NetPoint International','DACAS Corp','Electrica A-B SA de CV'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','BD ENTERPRISE NETWORKING LTD.','RRC RUSSIA','OCS Distribution Deutschland AG','Elcore Distribution AG'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Itancia Belgium','Westcon Group European Operations','Westcon Convergence Belgium','Westcon Convergence UK','Scansource Europe S.P.R.L.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','First Video Communications FZ LLC','ITANCIA (WAS NETACOM)','REDINGTON GULF','ITANCIA Africa','Westcon Africa FZCo, UNITED KINGDOM'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Anixter Southern Cone Region:CH,UY,PY,BO','AVT Inc., Caribbean & Cen America','Avnet Inc., Southern Cone Region','Netpoint International, Inc.','Importadora y Comercializadora Network1 International (Chile) Limitada','DACAS Corp','DITRI DACAS TECNOLOGY GROUP BOLIVA S.A.','Electrica A-B SA de CV'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','DACAS Corp','Electrica A-B SA de CV'];
	var DistiList10 = ['','DACAS Corp','Electrica A-B SA de CV'];
} else if (document.getElementsByName("country")[0].value=="Bosnia-Herzegovina"){
	var DistiList1 = ['Пожалуйста, выберите из списка','Ingram Micro Sp. z. o. o.','BD ENTERPRISE NETWORKING LTD.','Ingram Micro doo'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Comztek (Pty) Limited','International Distributors (Interdist) offshore SAL','Epsidon Technology (Pty) Ltd'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ANIXTER, INC (CALA)','ANIXTER DO BRASIL LTDA.','AVT Inc., Caribbean & Cen America','OLIBRAS TELECOMUNICAÇÕES LTDA','SCANSOURCE BRASIL DISTRIBUIDORA DE TECNOLOGIAS LTDA','WESTCON BRASIL'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Ingram Micro Sp. z. o. o.','BD ENTERPRISE NETWORKING LTD.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ITANCIA (WAS NETACOM)','REDINGTON GULF','ITANCIA Africa','Westcon Africa FZCo, UNITED KINGDOM','International Distributors (Interdist) offshore SAL'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ITANCIA (WAS NETACOM)','REDINGTON GULF','ITANCIA Africa','Westcon Africa FZCo, UNITED KINGDOM'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Elite Technology JSC.'];
	var DistiList10 = ['','Elite Technology JSC.'];
} else if (document.getElementsByName("country")[0].value=="Cameroon"){
	var DistiList1 = ['Пожалуйста, выберите из списка','First Video Communications FZ LLC','ITANCIA (WAS NETACOM)','REDINGTON GULF','ITANCIA Africa','Westcon Africa FZCo, UNITED KINGDOM','International Distributors (Interdist) offshore SAL'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','WESTCON CANADA','Ingram Micro Canada Inc-Nortel','Tech Data Canada Corporation'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Anixter Southern Cone Region:CH,UY,PY,BO','ANIXTER, INC (CALA)','AVT Inc., Caribbean & Cen America','Avnet Inc., Southern Cone Region','Netpoint International, Inc.','Importadora y Comercializadora Network1 International (Chile) Limitada','DACAS CHILE SPA'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','DIGITAL CHINA TECHNOLOGY LIMITED','Sichuan Changhong IT ermission Products Co., Ltd','Digital China (China) Limited','Sichuan Changhong IT ermission Avaya USD Stock','Unisplendour Xiaotong Tech. Co.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ANIXTER, INC (CALA)','ANIXTER COLOMBIA S.A.','Avnet Inc., Andean Region','Avnet Northern Cone','AVT Inc., Caribbean & Cen America','DACAS Colombia','Netpoint International, Inc.','Network1 International Colombia S.A.S.','Tech Data AS Colombia S.A.S.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Africa FZCo, UNITED KINGDOM'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ITANCIA Africa','Westcon Africa FZCo, UNITED KINGDOM','International Distributors (Interdist) offshore SAL','Epsidon Technology (Pty) Ltd'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ANIXTER, INC (CALA)','Anixter Central America Region','AVT Inc., Caribbean & Cen America','NetPoint International','DACAS Corp','Electrica A-B SA de CV'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Ingram Micro Sp. z. o. o.','BD ENTERPRISE NETWORKING LTD.','RRC BT POSLOVNE TELEKOMUNIKACIJE d.o.o.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','NetPoint International','DACAS Corp','Electrica A-B SA de CV'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','NETEKS ILETISIM URUNLERI DAGITIM ANONIM SIRKETI','TOPTEL TELEKOMUNIKASYON LTD','Westcon Convergence UK','Westcon Group European Operations','Westnet Distribution S.A. Greece'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','RRC-CZ S.R.O.','BD ENTERPRISE NETWORKING LTD.','Westcon Group European Operations Limited, Czech Republic'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','Westcon Convergence Nordics','Azlan Scandinavia','Scansource Europe S.P.R.L.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ITANCIA (WAS NETACOM)','ITANCIA Africa','Westcon Africa FZCo, UNITED KINGDOM'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ANIXTER, INC (CALA)','ANIXTER DOMINICAN REPUBLIC','AVT Inc., Caribbean & Cen America','NetPoint International','DACAS Corp','Electrica A-B SA de CV'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ANIXTER, INC (CALA)','Anixter Colombia S.A. Suc. Ecuador','AVT Inc., Caribbean & Cen America','Avnet Inc., Andean Region','Avnet Northern Cone','Netpoint International, Inc.','Network1 International Colombia S.A.S.','DACAS Corp'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','First Video Communications FZ LLC','APTEC DISTRIBUTION','Almasa IT Distribution FZCO','WESTCON MIDDLE EAST LIMITED','Mantrac Distribution','Westcon Africa FZCo, UNITED KINGDOM','International Distributors (Interdist) offshore SAL'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','ScanSource Communications GmbH Germany','Westcon Convergence Nordics','Scansource Europe S.P.R.L.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','First Video Communications FZ LLC','REDINGTON GULF','Westcon Africa FZCo, UNITED KINGDOM','International Distributors (Interdist) offshore SAL'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Arrow ECS Australia Pty Limited (formerly known as Distribution Central Pty Limited)'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','ScanSource Communications GmbH Germany','AZLAN LOGISTICS LTD','Westcon Convergence UK','Westcon Convergence Nordics','Azlan Finland Oy - Finland*','Westcon Convergence Finland','Scansource Europe S.P.R.L.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Convergence France','Westcon Group European Operations','ScanSource Communications GmbH Germany','ITANCIA (WAS NETACOM)','Westcon Convergence UK','ScanSource UK','Scansource Europe S.P.R.L.','ScanSource France'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ITANCIA (WAS NETACOM)','ITANCIA Africa','Westcon Africa FZCo, UNITED KINGDOM','International Distributors (Interdist) offshore SAL'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','KOMSA Kommunikation Sachsen AG','Westcon Group European Operations','ScanSource Communications GmbH Germany','AVAD GMBH','AZLAN LOGISTICS LTD','TECH DATA GMBH & CO. OHG','ScanSource UK','Westcon Convergence Germany','Ingram Micro Distribution GmbH','Scansource Europe S.P.R.L.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','AZLAN LOGISTICS LTD','TECH DATA SPAIN','Westcon Convergence UK','ScanSource UK','Scansource Europe S.P.R.L.','Westcon Convergence Spain'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westnet Distribution S.A.','Westcon Group European Operations','Westcon Convergence UK'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Convergence UK'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ChinaComm International Ltd','COL Limited','Sen Spirit Technology','SiS International Limited','Synnex Technology International (HK) Ltd.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','Ingram Micro Magyarország Kft','Ingram Micro Sp. z. o. o.','BD ENTERPRISE NETWORKING LTD.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Convergence Nordics','Scansource Europe S.P.R.L.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Brightstar Telecommunications India Limited','Redington India Limited','Savex Technologies Private Limited'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group Pte. Ltd. (Indonesia)','Synnex Metrodata Indonesia','ACA Pacific Technology (S) Pte Ltd','PT ACA Pacific Technology'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','AZLAN LOGISTICS LTD','Westcon Convergence UK','ScanSource UK','Scansource Europe S.P.R.L.','Almasa IT Distribution FZCO','Westcon Middle East Limitd'];
	var DistiList10 = ['','Westcon Group European Operations','AZLAN LOGISTICS LTD','Westcon Convergence UK','ScanSource UK','Scansource Europe S.P.R.L.','Almasa IT Distribution FZCO','Westcon Middle East Limitd'];
} else if (document.getElementsByName("country")[0].value=="Ireland"){
	var DistiList1 = ['Пожалуйста, выберите из списка','ITANCIA (WAS NETACOM)','ITANCIA Africa','Westcon Africa FZCo, UNITED KINGDOM'];
	var DistiList10 = ['','ITANCIA (WAS NETACOM)','ITANCIA Africa','Westcon Africa FZCo, UNITED KINGDOM'];
} else if (document.getElementsByName("country")[0].value=="Israel"){
	var DistiList1 = ['Пожалуйста, выберите из списка','ABnet Communications LTD'];
	var DistiList10 = ['','ABnet Communications LTD'];
} else if (document.getElementsByName("country")[0].value=="Italy"){
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','FIORE S.R.L.','ITANCIA (WAS NETACOM)','AVAD GMBH','Westcon Convergence Italy','Asit S.p.a','ITANCIA Srl'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','SYNNEX Infotec'];
	var DistiList10 = ['','SYNNEX Infotec'];
} else if (document.getElementsByName("country")[0].value=="Jersey"){
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','Westcon Convergence UK','ScanSource UK','Scansource Europe S.P.R.L.','AZLAN UK'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','MARVEL COMPUTER SOLUTIONS LTD','BD ENTERPRISE NETWORKING LTD.','RRC KAZAKHSTAN LLP','RRC RUSSIA','COMPTEK INTERNATIONAL OVERSEAS'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','JCS Co., LTD','PC Direct Inc.','SeAH Networks Co., Ltd.'];
	var DistiList10 = ['','JCS Co., LTD','PC Direct Inc.','SeAH Networks Co., Ltd.'];
} else if (document.getElementsByName("country")[0].value=="Kuwait"){
	var DistiList1 = ['Пожалуйста, выберите из списка','APTEC DISTRIBUTION','Almasa IT Distribution FZCO','WESTCON MIDDLE EAST LIMITED'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Almasa IT Distribution FZCO','Ingram Micro Levant s.a.l','International Distributors (Interdist) offshore SAL','WESTCON MIDDLE EAST LIMITED'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Comztek (Pty) Limited','Epsidon Technology (Pty) Ltd'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','APTEC DISTRIBUTION','Almasa IT Distribution FZCO','WESTCON MIDDLE EAST LIMITED','Mantrac Distribution','Westcon Africa FZCo, UNITED KINGDOM','International Distributors (Interdist) offshore SAL'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','AVAD GMBH','ScanSource Communications Schweiz','Westcon Convergence Germany','Scansource Europe S.P.R.L.','WGEO Switzerland GmbH'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ScanSource Communications GmbH Germany','Westcon Convergence Nordics','Scansource Europe S.P.R.L.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','Westcon Convergence Belgium','Scansource Europe S.P.R.L.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ChinaComm International Ltd','Synnex Technology International (HK) Ltd.','SiS International Limited','COL Limited'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','First Video Communications FZ LLC','Westcon Comztek (Pty) Limited','International Distributors (Interdist) offshore SAL','Epsidon Technology (Pty) Ltd'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Vnetwork System Sdn Bhd','Digital Paper Sdn Bhd','Westcon Solutions (M) Sdn Bhd'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Redington India Limited','Brightstar Telecommunications India Limited','International Distributors (Interdist) offshore SAL'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','Westcon Convergence UK'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ANIXTER, INC (CALA)','AVT Inc., Caribbean & Cen America','DACAS Corp'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','First Video Communications FZ LLC','REDINGTON GULF','Westcon Africa FZCo, UNITED KINGDOM','Epsidon Technology (Pty) Ltd','Westcon Africa FZCo. Mauritius'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ANIXTER DE MEXICO, SA DE CV','Centro de Conectividad, S.A. de C.V.','Electrica A-B SA de CV','Expertise Tech & Training S.A. de C.V.','TD Advanced Solutions México, S. de R.L. de C.V.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','BD ENTERPRISE NETWORKING LTD.','RRC RUSSIA','Elcore Distribution AG'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ANIXTER, INC (CALA)','AVT Inc., Caribbean & Cen America','NetPoint International','DACAS Corp'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Convergence Netherlands','Westcon Group European Operations','Westcon Convergence Belgium','Westcon Convergence UK','Scansource Europe S.P.R.L.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Arrow ECS Australia Pty Limited (formerly known as Distribution Central Pty Limited)','Westcon Group Limited (NZ)','Arrow ECS New Zealand Limited (formerly known as Distribution Central Limited)'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','AZLAN LOGISTICS LTD','Westcon Convergence Nordics','Azlan Norway*','Scansource Europe S.P.R.L.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','APTEC DISTRIBUTION','Almasa IT Distribution FZCO','WESTCON MIDDLE EAST LIMITED','Awan Distribution Pvt Ltd'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ANIXTER, INC (CALA)','ANIXTER PANAMA','AVT Inc., Caribbean & Cen America','NetPoint International','DACAS Corp'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ANIXTER, INC (CALA)','Anixter Argentina S.A.','AVT Inc., Caribbean & Cen America','Avnet Inc., Southern Cone Region','DACAS PARAGUAY SA'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ANIXTER, INC (CALA)','ANIXTER PERU','AVT Inc., Caribbean & Cen America','Avnet Inc., Southern Cone Region','NETWORK1 INTERNATIONAL PERU S.A.C.','Netpoint International, Inc.','It Dacas Peru Sac'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Ardent Networks Inc.','Westcon Group Pte. Ltd. (Philippines)','MSI-ECS (Phils) Inc.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','Ingram Micro Sp. z. o. o.','BD ENTERPRISE NETWORKING LTD.','Westcon Group European Operations Ltd. Poland'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','ITANCIA (WAS NETACOM)','AZLAN LOGISTICS LTD','TECH DATA SPAIN','Azlan Portugal','Westcon Portugal'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ANIXTER, INC (CALA)','ANIXTER PUERTO RICO, INC','AVT Inc., Caribbean & Cen America','NetPoint International','DACAS Corp','Electrica A-B SA de CV'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Ingram Micro Sp. z. o. o.','BD ENTERPRISE NETWORKING LTD.','RRC Tech Distribution'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','MARVEL COMPUTER SOLUTIONS LTD','BD ENTERPRISE NETWORKING LTD.','RRC RUSSIA','COMPTEK INTERNATIONAL OVERSEAS','LANMAX / LANDATA','OCS Distribution Deutschland AG'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ANIXTER, INC (CALA)','DACAS Corp'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','DACAS Corp'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Almasa IT Distribution FZCO','Brightstar Communications Company','Gulf Applications Co.','REDINGTON GULF'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','REDINGTON GULF','Westcon Africa FZCo, UNITED KINGDOM','International Distributors (Interdist) offshore SAL','Epsidon Technology (Pty) Ltd'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ACA Pacific Technology (S) Pte Ltd','Savex Singapore (Pte.) Limited','Westcon Group Pte. Ltd. (Singapore)'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','BD ENTERPRISE NETWORKING LTD.','Westcon Group European Operations Limited, Czech Republic'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','Ingram Micro Sp. z. o. o.','BD ENTERPRISE NETWORKING LTD.','RRC BUSINESS TELECOMMUNICATIONS'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Comztek (Pty) Limited','Even Flow Distribution'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','ITANCIA (WAS NETACOM)','AZLAN LOGISTICS LTD','TECH DATA SPAIN','Westcon Convergence Spain','Itancia Spain'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','First Video Communications FZ LLC'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','Westcon Convergence Nordics','Scansource Europe S.P.R.L.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Convergence France','Westcon Group European Operations','FIORE S.R.L.','ScanSource Communications GmbH Germany','AVAD GMBH','AZLAN LOGISTICS LTD','Westcon Convergence UK','ScanSource UK','ScanSource Communications Schweiz','Westcon Convergence Germany','Azlan AG','Scansource Europe S.P.R.L.','AVAD Switzerland AG','WGEO Switzerland GmbH'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ChinaComm Taiwan Ltd','Kingtel Technology Co., Ltd.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','First Video Communications FZ LLC','REDINGTON GULF','REDINGTON GULF','Westcon Africa FZCo, UNITED KINGDOM','International Distributors (Interdist) offshore SAL','Epsidon Technology (Pty) Ltd'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Tech Data Advanced Solutions (Thailand) Limited','Westcon Group Pte. Ltd. (Thailand)','ACA Pacific Technology (S) Pte Ltd','ACA Pacific Group Co., Ltd.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ANIXTER, INC (CALA)','AVT Inc., Caribbean & Cen America','Anixter Caribbean Region','NetPoint International','DACAS Corp'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','TOPTEL TELEKOMUNIKASYON LTD','NETEKS ILETISIM URUNLERI DAGITIM ANONIM SIRKETI','NFS Teknoloji'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','AVT Inc., Caribbean & Cen America','NetPoint International','DACAS Corp'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','UTTC LLP','BD ENTERPRISE NETWORKING LTD.','RRC UKRAINE','RRC RUSSIA'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group European Operations','AZLAN LOGISTICS LTD','Westcon Convergence UK','ScanSource UK','Scansource Europe S.P.R.L.','AZLAN UK'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Jenne, Inc.','CATALYST','TeleDynamics','Westcon/Synnex Group Inc.'];
	var DistiList10 = ['','Jenne, Inc.','CATALYST','TeleDynamics','Westcon/Synnex Group Inc.'];
} else if (document.getElementsByName("country")[0].value=="Uruguay"){
	var DistiList1 = ['Пожалуйста, выберите из списка','ANIXTER, INC (CALA)','Anixter Argentina S.A.','AVT Inc., Caribbean & Cen America','Avnet Inc., Southern Cone Region','ANIXTER DISTRIBUIDOR DE SOLUCIONES EMPRESARIALES E INDUSTRIALES S.A.','Dacas Uruguay S.A.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ANIXTER, INC (CALA)','Anixter Andean Region:VE,EC','AVT Inc., Caribbean & Cen America','Avnet Inc., Andean Region','Avnet Northern Cone','Netpoint International, Inc.','Avnet Technology Solutions Venezuela C.A','Network1 International Colombia S.A.S.','DACAS Corp','DACAS Venezuela'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','Westcon Group Pte. Ltd. (Vietnam)','Starview Vietnam Ltd','Starview International Pte Ltd','Elite Technology JSC.'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','ITANCIA (WAS NETACOM)','ITANCIA Africa'];
	var DistiList10 = ['','ITANCIA (WAS NETACOM)','ITANCIA Africa'];
} else if (document.getElementsByName("country")[0].value=="Yemen"){
	var DistiList1 = ['Пожалуйста, выберите из списка','Almasa IT Distribution FZCO','REDINGTON GULF','WESTCON MIDDLE EAST LIMITED'];
	...
	var DistiList1 = ['Пожалуйста, выберите из списка','First Video Communications FZ LLC','REDINGTON GULF','Westcon Comztek (Pty) Limited','International Distributors (Interdist) offshore SAL','Epsidon Technology (Pty) Ltd'];
	...
	var DistiList10 = ['','Westcon Comztek (Pty) Limited','International Distributors (Interdist) offshore SAL','Epsidon Technology (Pty) Ltd'];
		...
		/*} else if (document.getElementsByName("Theater")[0].value == "US"){
			vDistributorName.options.length = 0;
			var DistiList2 = ['Пожалуйста, выберите из списка','ScanSource Catalys','Jenne','Westcon'];
			...
			vDistributorName.options.length = 0;
			var DistiList3 = ['Пожалуйста, выберите из списка','Ingram Micro','Tech Data Corporation','Westcon'];
			...
			vDistributorName.options.length = 0;
			var DistiList4 = ['Пожалуйста, выберите из списка','Anixter','TechData','Scansource'];
		...
		var field17 = new LiveValidation( "field17", { validMessage: "", onlyOnBlur: true });
		field17.enable();
		field17.add( Validate.Presence, { failureMessage: "Это поле обязательно к заполнению" } );		
		var field16 = new LiveValidation( "field16", { validMessage: "", onlyOnBlur: true });
		field16.disable();
		document.getElementById("formElement16").style.display = "none";
		var field18 = new LiveValidation( "field18", { validMessage: "", onlyOnBlur: true });
		...
		var field18 = new LiveValidation( "field18", { validMessage: "", onlyOnBlur: true });
		field18.enable();
		field18.add( Validate.Presence, { failureMessage: "Это поле обязательно к заполнению" } );		
		var field16 = new LiveValidation( "field16", { validMessage: "", onlyOnBlur: true });
		field16.disable();
		document.getElementById("formElement16").style.display = "none";
		var field17 = new LiveValidation( "field17", { validMessage: "", onlyOnBlur: true });
...
//for Validation
field0.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
field1.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
field2.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
field3.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
field3.add(Validate.Format, {pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i, failureMessage: "Требуется действительный адрес электронной почты"});
field4.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
field5.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
field8.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
field11.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
field14.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
field15.add(Validate.Presence, {failureMessage:"Это поле обязательно к заполнению"});
   ...
   var e = document.getElementsByName("country")[0];
	...
	if (strUser=="United States"){
	  ...
	  //document.getElementById("Regiondiv").style.display = "block";
          var RegUS = ['Пожалуйста, выберите из списка','Авторизованный партнёр Avaya','Партнер по Avaya Open Product','Distributor Partner'];
          var RegUSO = ['','Avaya Authorized Reseller','Open Product Reseller','Distributor Partner'];
		  var RegCAN = ['Пожалуйста, выберите из списка','Авторизованный партнёр Avaya','Партнер по Avaya Open Product','Distributor Partner'];
          var RegCANO = ['','Avaya Authorized Reseller','Open Product Reseller','Distributor Partner'];
		  //var RegUS = ['Пожалуйста, выберите из списка','Авторизованный партнёр Avaya','Партнер по Avaya Open Product','Avaya Sales Agent','Avaya Distributor'];
          //var RegUSO = ['','Авторизованный партнёр Avaya','Партнер по Avaya Open Product','Avaya Sales Agent','Avaya Distributor'];
		  var RegME = ['Пожалуйста, выберите из списка','Авторизованный партнёр Avaya','Зарегистрированный партнёр Avaya','Партнер по Avaya Open Product','Distributor Partner'];
          var RegMEO = ['','Avaya Authorized Reseller','Avaya Registered Reseller','Open Product Reseller','Distributor Partner'];
		  var RegAL = ['Пожалуйста, выберите из списка','Авторизованный партнёр Avaya','Партнер по Avaya Open Product','Distributor Partner'];
          var RegALO = ['','Avaya Authorized Reseller','Open Product Reseller','Distributor Partner'];
             switch (regionSel) {
                case 'US':
                vPartnerType.options.length = 0;
			createOption(vPartnerType, "Пожалуйста, выберите из списка", "");
...
partnertype.onchange = function() {
	if(document.getElementsByName("PartnerType")[0].value == "Avaya Authorized Reseller"){
		...
		if (document.getElementById("partTypeDesc").style.display != "none"){
			...
			document.getElementById('PartTypeDescLabel').innerHTML = "Продавайте полный портфель решений Avaya клиентам";
		...
		if (document.getElementById("partTypeDesc").style.display != "none"){
			...
			document.getElementById('PartTypeDescLabel').innerHTML = "Продавайте специализированный портфель решений Avaya клиентам";
		} else {
			document.getElementById("partTypeDesc").style.display = "block";
			document.getElementById('PartTypeDescLabel').innerHTML = "Продавайте специализированный портфель решений Avaya клиентам";
		}
		...
		if (document.getElementById("partTypeDesc").style.display != "none"){
			//Sell limited Avaya portfolio to end customers
			document.getElementById('PartTypeDescLabel').innerHTML = "Продажа устройств и телефонов (Avaya Open Products) через дистрибьютора";
		} else {
			document.getElementById("partTypeDesc").style.display = "block";
			document.getElementById('PartTypeDescLabel').innerHTML = "Продажа устройств и телефонов (Avaya Open Products) через дистрибьютора";
		}
		...
		if (document.getElementById("partTypeDesc").style.display != "none"){
			...
			document.getElementById('PartTypeDescLabel').innerHTML = "Продавайте SIP и другие продукты";
		} else {
			document.getElementById("partTypeDesc").style.display = "block";
			document.getElementById('PartTypeDescLabel').innerHTML = "Продавайте SIP и другие продукты";
		}
		...
		if (document.getElementById("partTypeDesc").style.display != "none"){
			...
			document.getElementById('PartTypeDescLabel').innerHTML = "Продавайте облачные решения через посредника";
		} else {
			document.getElementById("partTypeDesc").style.display = "block";
			document.getElementById('PartTypeDescLabel').innerHTML = "Продавайте облачные решения через посредника";
		}
	...
	//		document.getElementById('PartTypeDescLabel').innerHTML = "Продавайте авторизованным партнёрам Avaya";
	//	} else {
	//			document.getElementById("partTypeDesc").style.display = "block";
	//			document.getElementById('PartTypeDescLabel').innerHTML = "Продавайте авторизованным партнёрам Avaya";
	//	}
...
privacytclink.setAttribute("width","100%");
...
privacytclink.innerHTML = "<font style='font-size:13px;line-height:20px;font-weight:normal;'>Отправляя эту форму, я даю согласие на обработку указанной информации в базе данных Avaya Для более детальной информации ознакомьтесь с нашей <a href='https:\/\/www.avaya.com/ru/privacy/website/' target='_blank' style='color:#DA291C;text-decoration:underline;font-family:\"HCo Gotham SSm\";font-size:13px;'>Политикой Конфиденциальности</a>. Кроме того, вы можете в любой момент изменить ваши <a href='https:\/\/news.avaya.com/partner-preference-center' target='_blank' style='color:#DA291C;;font-size:13px;text-decoration:underline;font-family:\"HCo Gotham SSm\"'>предпочтения по электронной рассылке</a>. </font><br><br>";
...
/*GA*/
 ...
 document.getElementById('form2513').addEventListener(
